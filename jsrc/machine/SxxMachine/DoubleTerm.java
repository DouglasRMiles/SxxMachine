...
public class DoubleTerm extends NumberTerm {
	...
	public NumberTerm abs() {
		return Float(Math.abs(this.value));
	}

	@Override
	public NumberTerm acos() {
		return Float(Math.acos(this.value));
	}
	...
	public NumberTerm asin() {
		return Float(Math.asin(this.value));
	}

	@Override
	public NumberTerm atan() {
		return Float(Math.atan(this.value));
	}

	@Override
	public NumberTerm ceil() {
		return Integer((long) Math.ceil(this.value));
	}
	...
	public NumberTerm exp() {
		return Float(Math.exp(this.value));
	}
	...
	public NumberTerm max(NumberTerm t) {
		return Float(Math.max(this.value, t.doubleValue()));
	}

	@Override
	public NumberTerm min(NumberTerm t) {
		return Float(Math.min(this.value, t.doubleValue()));
	}
	...
	public NumberTerm pow(NumberTerm t) {
		return Float(Math.pow(this.value, t.doubleValue()));
	}

	@Override
	public NumberTerm rint() {
		return Float(Math.rint(this.value));
	}

	@Override
	public NumberTerm round() {
		return Integer(Math.round(this.value));
	}
	...
	public NumberTerm signum() {
		return Float(Math.signum(this.value));
	}
