...
public class TermData {
  ...
  static public class StaticPred extends Predicate implements Operation {
    ...
    public StaticPred(String functor, Operation object, Term[] va,
        Operation cont) {
...
//  }
  ...
  public static Predicate Op(Operation object, Term a1, Term a2,
      Operation cont) {
    return new TermData.StaticPred(null, object, VA(a1, a2), cont);
  }

  public static Predicate Op(Operation object, Term a1, Term a2, Term a3,
      Operation cont) {
  ...
  public static ErrorTerm createErrorTerm(Throwable error, Term _functor,
      Term... _args) {
