...
public class PrologClassLoader extends ClassLoader {
   ...
   * @return the predicate encapsulating the logic and the arguments.
   */
  public Operation predicate(String pkg, String functor, Operation cont,
      Term... args) {
    ...
    try {
      ...
      if (constructor != NOT_FOUND) {
        Predicate pred =
            new TermData.StaticPred(functor, constructor, args, cont);
        return pred;
      }
      ...
      ExistenceException err2 = new ExistenceException("procedure",
          term(pkg, functor, arity), cause.toString());
      err2.initCause(cause);
      throw err2;
    }
    throw new ExistenceException("procedure", term(pkg, functor, arity),
        "NOT_FOUND");
  }

  private static StructureTerm term(String pkg, String functor, int arity) {
    return new StructureTerm(":", SymbolTerm.create(pkg), new StructureTerm("/",
        SymbolTerm.create(functor), TermData.Integer(arity)));
  }
  ...
  // return cons;
  // }
  private Operation findPredicate(String pkg, String functor, int arity)
      throws ClassNotFoundException {
    ...
    if (constructor == null) {
      ...
      if (constructor == null) throw new ClassNotFoundException("" + key);
  ...
  public static final class Key {
    ...
    public boolean equals(Object other) {
      if (other instanceof Key) {
        Key b = (Key) other;
        return this.arity == b.arity && this.pkg.equals(b.pkg)
            && this.functor.equals(b.functor);
      }
      return false;
    }
  }
