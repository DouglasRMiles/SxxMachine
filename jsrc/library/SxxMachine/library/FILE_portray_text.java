...
public class FILE_portray_text  extends TermData {
	...
	*/
	...
	private final static Operation $dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_2(Prolog m) {
		...
		return //
		Op((Prolog e) -> PRED_format_2_static_exec(e), VA(PRED_$dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_s1, a3), cont);
	}
										...
										Op((Prolog e) -> PRED_all_ascii_1_static_exec(e), VA(a3), //
												Op((Prolog e) -> PRED_call_1_static_exec(e), VA(a11), //
														Op((Prolog e) -> PRED_put_char_1_static_exec(e), VA(ATOM_$0022), //
																Op((Prolog e) -> PRED_$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_6_static_exec(e),
																		VA(a3, a4, a9, V(m), V(m), a12), //
																		Op((Prolog e) -> PRED_$dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_static_exec(e),
																				VA(a5, a12), //
																				Op((Prolog e) -> PRED_put_char_1_static_exec(e), VA(ATOM_$0022), cont))))))))));
	}
	...
	*/
	...
	public static Operation PRED_put_var_codes_1_static_exec(Prolog m) {
		...
		m.cont = cont;
		m.setB0();
		return m.switch_on_term(FILE_portray_text::put_var_codes_1_var, FILE_portray_text::put_var_codes_1_1, FILE_portray_text::put_var_codes_1_1, FILE_portray_text::put_var_codes_1_con,
	...
	*/
	...
	public static Operation PRED_emit_code_1_static_exec(Prolog m) {
		...
		m.cont = cont;
		m.setB0();
		return m.switch_on_term(FILE_portray_text::emit_code_1_var, FILE_portray_text::emit_code_1_var, FILE_portray_text::emit_code_1_5, FILE_portray_text::emit_code_1_5, FILE_portray_text::emit_code_1_5,
	...
	*/
	...
	public static Operation PRED_all_ascii_1_static_exec(Prolog m) {
		...
		m.cont = cont;
		m.setB0();
		return m.switch_on_term(FILE_portray_text::all_ascii_1_var, FILE_portray_text::all_ascii_1_1, FILE_portray_text::all_ascii_1_1, FILE_portray_text::all_ascii_1_con, FILE_portray_text::all_ascii_1_1,
	...
	*/
	...
	public static Operation PRED_ascii_code_1_static_exec(Prolog m) {
		...
		m.cont = cont;
		m.setB0();
		return m.switch_on_term(FILE_portray_text::ascii_code_1_var, FILE_portray_text::ascii_code_1_var, FILE_portray_text::ascii_code_1_4, FILE_portray_text::ascii_code_1_4, FILE_portray_text::ascii_code_1_4,
	...
	*/
	...
	public static Operation PRED_var_or_numbered_1_static_exec(Prolog m) {
		...
		m.cont = cont;
		m.setB0();
		return m.switch_on_term(FILE_portray_text::var_or_numbered_1_var, FILE_portray_text::var_or_numbered_1_1, FILE_portray_text::var_or_numbered_1_1, FILE_portray_text::var_or_numbered_1_1,
	...
	*/
		...
		Op((Prolog e) -> PRED_assertz_1_static_exec(e), VA(PRED_$init_0_s11), //
				Op((Prolog e) -> PRED_assertz_1_static_exec(e), VA(PRED_$init_0_s20), //
						Op((Prolog e) -> PRED_assertz_1_static_exec(e), VA(PRED_$init_0_s28), //
								Op((Prolog e) -> PRED_$new_indexing_hash_3_static_exec(e), VA(ATOM_portray_text, PRED_$init_0_s33, V(m)), cont))));
	}
	...
	static public void loadPreds() {
		...
		PredTable.registerBuiltin("$dummy_0_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl",
				"$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl", 6,
		...
		PredTable.registerBuiltin("$dummy_1_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl",
				"$dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl", 2,
