...
public class FILE_portray_text extends FILE_builtins {
...
*/
    ...
    // portray_text(A):-[must_be(boolean,A),retractall(portray_text:do_portray_text(B)),assert(portray_text:do_portray_text(A))]
        ...
        a5 = S(":", y4);
        return //
 Op((e)->PRED_must_be_2_static_exec(e), VA(PRED_portray_text_1_s1, a1), //
 Op((e)->PRED_retractall_1_static_exec(e), VA(a3), //
 Op((e)->PRED_assert_1_static_exec(e), VA(a5), cont)));
    }
...
m.cont = cont;
    ...
    // set_portray_text(min_length,A):-[must_be(nonneg,A),retractall(portray_text:portray_text_option(min_length,B)),assert(portray_text:portray_text_option(min_length,A))]
        ...
        a6 = S(":", y4);
        return //
 Op((e)->PRED_must_be_2_static_exec(e), VA( ATOM_nonneg , a2), //
 Op((e)->PRED_retractall_1_static_exec(e), VA(a4), //
 Op((e)->PRED_assert_1_static_exec(e), VA(a6), cont)));
    }
...
*/
    ...
    public static Operation PRED_$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_6_static_exec(Prolog m) { 
        Operation cont = m.cont; Term[] LARG = m.AREGS; Operation thiz = m.pred;  
m.cont = cont;
        m.setB0();
        m.jtry6(null, FILE_portray_text::$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_6_sub_1);
    ...
    private final static Operation $dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_6_sub_1(Prolog m) { 
        m.trust(null);
    ...
    private final static Operation $dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_6_1(Prolog m) { 
    ...
    // '$dummy_0_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl'(A,B,C,D,E,F):-['$get_level'(G),'$greater_than'(B,C),'$cut'(G),D is C-5,E is B-5,skip_first(E,A,F),put_n_codes(D,A),format(...,[])]
        ...
        //END inline expansion
        return //
 Op((e)->PRED_skip_first_3_static_exec(e), VA(a5, a1, a6), //
 Op((e)->PRED_put_n_codes_2_static_exec(e), VA(a4, a1), //
 Op((e)->PRED_format_2_static_exec(e), VA( ATOM_$002E$002E$002E ,  Prolog.Nil ), cont)));
    }

    private final static Operation $dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_6_2(Prolog m) { 
...
from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl
*/
    private static final SymbolTerm PRED_$dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_s1 = SYM("~s");




    public static Operation PRED_$dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_static_exec(Prolog m) { 
        Operation cont = m.cont; Term[] LARG = m.AREGS; Operation thiz = m.pred;  
m.cont = cont;
        m.setB0();
        m.jtry2(null, FILE_portray_text::$dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_sub_1);
    ...
    private final static Operation $dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_sub_1(Prolog m) { 
        m.trust(null);
    ...
    private final static Operation $dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_1(Prolog m) { 
    ...
    // '$dummy_1_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl'(A,B):-['$get_level'(C),var_or_numbered(A),'$cut'(C),put_var_codes(B)]
        ...
        //END inline expansion
        return //
 Op((e)->PRED_var_or_numbered_1_static_exec(e), VA(a1), //
 Op((e)->PRED_$cut_1_static_exec(e), VA(a3), //
 Op((e)->PRED_put_var_codes_1_static_exec(e), VA(a2), cont)));
    }

    private final static Operation $dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_2(Prolog m) { 
    ...
    // '$dummy_1_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl'(A,B):-[format('~s',[B])]
        ...
        return //
 Op((e)->PRED_format_2_static_exec(e), VA(PRED_$dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_s1, a3), cont);
    }
/** PREDICATE: (:)/2
from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl
*/
    ...
    // user:portray(A):-[call(portray_text:do_portray_text(true)),'$skip_list'(B,A,C),call(portray_text:portray_text_option(min_length,D)),'$greater_or_equal'(B,D),all_ascii(A),call(portray_text:portray_text_option(ellipsis,E)),put_char('"'),'$dummy_0_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl'(A,B,E,F,G,H),'$dummy_1_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl'(C,H),put_char('"')]
        ...
        a12 = V(m);
        return //
 Op((e)->PRED_call_1_static_exec(e), VA(PRED_$003A_2_s10), //
 Op((e)->PRED_$skip_list_3_static_exec(e), VA(a4, a3, a5), //
 Op((e)->PRED_call_1_static_exec(e), VA(a8), //
 Op((e)->PRED_$greater_or_equal_2_static_exec(e), VA(a4, a6), //
 Op((e)->PRED_all_ascii_1_static_exec(e), VA(a3), //
 Op((e)->PRED_call_1_static_exec(e), VA(a11), //
 Op((e)->PRED_put_char_1_static_exec(e), VA( ATOM_$0022 ), //
 Op((e)->PRED_$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_6_static_exec(e), VA(a3, a4, a9, V(m), V(m), a12), //
 Op((e)->PRED_$dummy_1_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Flibrary$002Fportray_text$002Epl_2_static_exec(e), VA(a5, a12), //
 Op((e)->PRED_put_char_1_static_exec(e), VA( ATOM_$0022 ), cont))))))))));
    }
...
m.cont = cont;
    ...
    // put_n_codes(A,[B|C]):-['$get_level'(D),E is 0,'$greater_than'(A,E),'$cut'(D),emit_code(B),F is A-1,put_n_codes(F,C)]
        ...
        a8 = S("-", y1);
        return //
 Op((e)->PRED_emit_code_1_static_exec(e), VA(a3), //
 Op(FILE_builtins::PRED_is_2_static_exec, VA(a7, a8), //
 Op((e)->PRED_put_n_codes_2_static_exec(e), VA(a7, a4), cont)));
    }

    private final static Operation put_n_codes_2_2(Prolog m) { 
    // put_n_codes(A,B):-true
         Term a1, a2;
        Operation cont;
        a1 = m.AREGS[0];
        a2 = m.AREGS[1];
...
m.cont = cont;
    ...
    // skip_first(A,[B|C],D):-['$get_level'(E),succ(F,A),'$cut'(E),skip_first(F,C,D)]
        ...
        a6 = V(m);
        return //
 Op((e)->PRED_succ_2_static_exec(e), VA(a6, a1), //
 Op((e)->PRED_$cut_1_static_exec(e), VA(a5), //
 Op((e)->PRED_skip_first_3_static_exec(e), VA(a6, a4, a3), cont)));
    }
...
m.cont = cont;
 ...
 Op((e)->PRED_format_2_static_exec(e), VA(PRED_put_var_codes_1_s1, a3), cont)));
    }
    ...
    // put_var_codes([A|B]):-[emit_code(A),put_var_codes(B)]
        ...
        return //
 Op((e)->PRED_emit_code_1_static_exec(e), VA(a2), //
 Op((e)->PRED_put_var_codes_1_static_exec(e), VA(a3), cont));
    }
...
m.cont = cont;
    ...
    // emit_code(8):-['$neck_cut',format('\\b')]
        ...
        //END inline expansion
        return //
 Op((e)->PRED_format_1_static_exec(e), VA( ATOM_$005Cb ), cont);
    }
    ...
    // emit_code(13):-['$neck_cut',format('\\r')]
        ...
        //END inline expansion
        return //
 Op((e)->PRED_format_1_static_exec(e), VA( ATOM_$005Cr ), cont);
    }
    ...
    // emit_code(10):-['$neck_cut',format('\\n')]
        ...
        //END inline expansion
        return //
 Op((e)->PRED_format_1_static_exec(e), VA( ATOM_$005Cn ), cont);
    }
    ...
    // emit_code(9):-['$neck_cut',format('\\t')]
        ...
        //END inline expansion
        return //
 Op((e)->PRED_format_1_static_exec(e), VA( ATOM_$005Ct ), cont);
    }
    ...
    // emit_code(A):-[put_code(A)]
        return //
 Op((e)->PRED_put_code_1_static_exec(e), VA(a1), cont);
    }
...
m.cont = cont;
 ...
 Op((e)->PRED_$cut_1_static_exec(e), VA(a2), cont));
    ...
    // all_ascii([A|B]):-[isascii(A),all_ascii(B)]
        ...
        return //
 Op((e)->PRED_isascii_1_static_exec(e), VA(a2), //
 Op((e)->PRED_all_ascii_1_static_exec(e), VA(a3), cont));
    }
/** PREDICATE: isascii/1
from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/library/portray_text.pl
*/
    ...
    // isascii(A):-['$get_level'(B),integer(A),ascii_code(A),'$cut'(B)]
        ...
        //END inline expansion
        return //
 Op((e)->PRED_ascii_code_1_static_exec(e), VA(a1), //
 Op((e)->PRED_$cut_1_static_exec(e), VA(a2), cont));
    }
...
m.cont = cont;
    ...
    // ascii_code(A):-[between(32,126,A)]
        return //
 Op((e)->PRED_between_3_static_exec(e), VA( int_32 ,  int_126 , a1), cont);
    }
...
*/
 ...
 Op((e)->PRED_assertz_1_static_exec(e), VA(PRED_$init_0_s20), //
 Op((e)->PRED_assertz_1_static_exec(e), VA(PRED_$init_0_s28), //
 Op((e)->PRED_$new_indexing_hash_3_static_exec(e), VA( ATOM_portray_text , PRED_$init_0_s33, V(m)), cont))));
    }
static { loadPreds(); }
