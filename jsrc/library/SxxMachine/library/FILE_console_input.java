...
public class FILE_console_input extends FILE_builtins {
/** PREDICATE: (:)/2
...
*/
    ...
    // prolog:complete_input(A,B,C,D):-[string_codes(A,E),reverse(E,F),complete(F,C,D)]
        ...
        a7 = V(m);
        return //
 Op((e)->PRED_string_codes_2_static_exec(e), VA(a3, a6), //
 Op((e)->PRED_reverse_2_static_exec(e), VA(a6, a7), //
 Op((e)->PRED_complete_3_static_exec(e), VA(a7, a4, a5), cont)));
    }
...
m.cont = cont;
    ...
    // complete(A,B,C):-['$get_level'(D),phrase(file_prefix(B),A,E),'$cut'(D),atom_concat(B,*,F),expand_file_name(F,C)]
        ...
        a6 = V(m);
        return //
 Op((e)->PRED_phrase_3_static_exec(e), VA(a5, a1, V(m)), //
 Op((e)->PRED_$cut_1_static_exec(e), VA(a4), //
 Op((e)->PRED_atom_concat_3_static_exec(e), VA(a2,  ATOM_$002A , a6), //
 Op((e)->PRED_expand_file_name_2_static_exec(e), VA(a6, a3), cont))));
    }
 ...
 Op((e)->PRED_phrase_3_static_exec(e), VA(a5, a1, V(m)), //
 Op((e)->PRED_$cut_1_static_exec(e), VA(a4), //
 Op((e)->PRED_$atom_completions_2_static_exec(e), VA(a2, a3), cont)));
    }
...
*/
    ...
    // atom_prefix(A,B,C):-[atom_chars(D,B,E),reverse(D,F),string_codes(A,F),'$unify'(C,E)]
        ...
        a6 = V(m);
        return //
 Op((e)->PRED_atom_chars_3_static_exec(e), VA(a4, a2, a5), //
 Op((e)->PRED_reverse_2_static_exec(e), VA(a4, a6), //
 Op((e)->PRED_string_codes_2_static_exec(e), VA(a1, a6), //
...
m.cont = cont;
    ...
    // atom_chars([A|B],C,D):-['$get_level'(E),atom_char(A,C,F),'$cut'(E),'$unify'(G,F),atom_chars(B,G,D)]
        ...
        a8 = V(m);
        return //
 Op((e)->PRED_atom_char_3_static_exec(e), VA(a4, a2, a7), //
 Op((e)->PRED_$cut_1_static_exec(e), VA(a6), //
 Op((e)->PRED_$unify_2_static_exec(e), VA(a8, a7), //
 Op((e)->PRED_atom_chars_3_static_exec(e), VA(a5, a8, a3), cont))));
    }
...
*/
    ...
    // atom_char(A,[A|B],C):-[atom_char(A),'$unify'(C,B)]
        ...
        return //
 Op((e)->PRED_atom_char_1_static_exec(e), VA(a1), //
 Op((e)->PRED_$unify_2_static_exec(e), VA(a3, a4), cont));
    }
...
*/
    ...
    // atom_char(A):-[code_type(A,csym)]
        return //
 Op((e)->PRED_code_type_2_static_exec(e), VA(a1, PRED_atom_char_1_s1), cont);
    }
...
*/
    ...
    // file_prefix(A,B,C):-[file_chars(D,B,E),'$unify'(E,[39|F]),reverse(D,G),atom_codes(A,G),'$unify'(C,F)]
        ...
        a8 = V(m);
        return //
 Op((e)->PRED_file_chars_3_static_exec(e), VA(a4, a2, a5), //
 Op((e)->PRED_$unify_2_static_exec(e), VA(a5, a7), //
 Op((e)->PRED_reverse_2_static_exec(e), VA(a4, a8), //
 Op((e)->PRED_atom_codes_2_static_exec(e), VA(a1, a8), //
...
m.cont = cont;
    ...
    // file_chars([A|B],C,D):-['$get_level'(E),file_char(A,C,F),'$cut'(E),'$unify'(G,F),file_chars(B,G,D)]
        ...
        a8 = V(m);
        return //
 Op((e)->PRED_file_char_3_static_exec(e), VA(a4, a2, a7), //
 Op((e)->PRED_$cut_1_static_exec(e), VA(a6), //
 Op((e)->PRED_$unify_2_static_exec(e), VA(a8, a7), //
 Op((e)->PRED_file_chars_3_static_exec(e), VA(a5, a8, a3), cont))));
    }
...
*/
    ...
    // file_char(A,[A|B],C):-[file_char(A),'$unify'(C,B)]
        ...
        return //
 Op((e)->PRED_file_char_1_static_exec(e), VA(a1), //
 Op((e)->PRED_$unify_2_static_exec(e), VA(a3, a4), cont));
    }
...
m.cont = cont;
    ...
    // file_char(A):-[code_type(A,csym)]
        return //
 Op((e)->PRED_code_type_2_static_exec(e), VA(a1, PRED_file_char_1_s1), cont);
    }
