...
m.cont = cont;
    ...
    // top:-[queens(8,A),fail]
        return //
 Op((e)->PRED_queens_2_static_exec(e), VA(PRED_top_0_s1, V(m)), //
 Op(fail_0, VA(), cont));
    }
...
*/
    ...
    // queens(A,B):-[range(1,A,C),queens(C,[],B)]
        a3 = V(m);
        return //
 Op((e)->PRED_range_3_static_exec(e), VA(PRED_queens_2_s1, a1, a3), //
...
*/
    ...
    // not_attack(A,B):-[not_attack(A,B,1)]
        return //
 Op((e)->PRED_not_attack_3_static_exec(e), VA(a1, a2, PRED_not_attack_2_s1), cont);
    }
