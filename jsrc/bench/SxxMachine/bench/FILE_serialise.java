...
public class FILE_serialise extends FILE_builtins {
/** PREDICATE: top/0
...
*/
    ...
    // serialise:-[serialise([65,66,76,69,32,87,65,83,32,73,32,69,82,69,32,73,32,83,65,87,32,69,76,66,65],A)]
        return //
 Op((e)->PRED_serialise_2_static_exec(e), VA(PRED_serialise_0_s35, V(m)), cont);
    }
...
*/
 ...
 Op((e)->PRED_numbered_3_static_exec(e), VA(a4, PRED_serialise_2_s1, V(m)), cont)));
    }
