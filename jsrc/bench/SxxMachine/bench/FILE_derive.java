...
public class FILE_derive  extends TermData {
	...
	*/
	...
	public static Operation PRED_top_0_static_exec(Prolog m) {
		...
		// top:-[ops8,log10,divide10]
		return //
		Op((Prolog e) -> PRED_ops8_0_static_exec(e), VA(), //
				Op((Prolog e) -> PRED_log10_0_static_exec(e), VA(), //
						Op((Prolog e) -> PRED_divide10_0_static_exec(e), VA(), cont)));
	}
	...
	*/
	...
	public static Operation PRED_ops8_0_static_exec(Prolog m) {
		...
		// ops8:-[d((x+1)*((x^2+2)*(x^3+3)),x,A)]
		return //
		Op((Prolog e) -> PRED_d_3_static_exec(e), VA(PRED_ops8_0_s21, ATOM_x, V(m)), cont);
	}
	...
	*/
	...
	public static Operation PRED_divide10_0_static_exec(Prolog m) {
		...
		// divide10:-[d(x/x/x/x/x/x/x/x/x/x,x,A)]
		return //
		Op((Prolog e) -> PRED_d_3_static_exec(e), VA(PRED_divide10_0_s20, ATOM_x, V(m)), cont);
	}
