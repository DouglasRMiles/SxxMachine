...
public class FILE_derive extends FILE_builtins {
/** PREDICATE: top/0
from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/derive.pl
*/
    ...
    // top:-[ops8,log10,divide10]
        return //
 Op((e)->PRED_ops8_0_static_exec(e), VA(), //
 Op((e)->PRED_log10_0_static_exec(e), VA(), //
 Op((e)->PRED_divide10_0_static_exec(e), VA(), cont)));
    }
/** PREDICATE: ops8/0
from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/derive.pl
*/
...
*/
    ...
    // log10:-[d(log(log(log(log(log(log(log(log(log(log(x)))))))))),x,A)]
        return //
 Op((e)->PRED_d_3_static_exec(e), VA(PRED_log10_0_s22,  ATOM_x , V(m)), cont);
    }
/** PREDICATE: divide10/0
from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/derive.pl
*/
    private static final StructureTerm PRED_divide10_0_s4 = S("/",  ATOM_x ,  ATOM_x );
    private static final StructureTerm PRED_divide10_0_s6 = S("/", PRED_divide10_0_s4,  ATOM_x );
    private static final StructureTerm PRED_divide10_0_s8 = S("/", PRED_divide10_0_s6,  ATOM_x );
    private static final StructureTerm PRED_divide10_0_s10 = S("/", PRED_divide10_0_s8,  ATOM_x );
    private static final StructureTerm PRED_divide10_0_s12 = S("/", PRED_divide10_0_s10,  ATOM_x );
    private static final StructureTerm PRED_divide10_0_s14 = S("/", PRED_divide10_0_s12,  ATOM_x );
    private static final StructureTerm PRED_divide10_0_s16 = S("/", PRED_divide10_0_s14,  ATOM_x );
    private static final StructureTerm PRED_divide10_0_s18 = S("/", PRED_divide10_0_s16,  ATOM_x );
    private static final StructureTerm PRED_divide10_0_s20 = S("/", PRED_divide10_0_s18,  ATOM_x );
    ...
    // divide10:-[d(x/x/x/x/x/x/x/x/x/x,x,A)]
        return //
 Op((e)->PRED_d_3_static_exec(e), VA(PRED_divide10_0_s20,  ATOM_x , V(m)), cont);
    }
/** PREDICATE: d/3
from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/derive.pl
*/
...
m.cont = cont;
    ...
    private final static Operation d_3_int(Prolog m) { 
        m.jtry3(null, FILE_derive::d_3_int_1);
        return d_3_9(m);
    }
