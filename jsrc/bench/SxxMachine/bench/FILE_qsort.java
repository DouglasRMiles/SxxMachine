...
public class FILE_qsort  extends TermData {
	/** PREDICATE: top/0
	...
	*/
	...
	public static Operation PRED_top_0_static_exec(Prolog m) {
		...
		// top:-[qsort]
		return //
		Op((Prolog e) -> PRED_qsort_0_static_exec(e), VA(), cont);
	}
	...
	*/
	...
	public static Operation PRED_qsort_0_static_exec(Prolog m) {
		...
		// qsort:-[qsort([27,74,17,33,94,18,46,83,65,2,32,53,28,85,99,47,28,82,6,11,55,29,39,81,90,37,10,0,66,51,7,21,85,27,31,63,75,4,95,99,11,28,61,74,18,92,40,53,59,8],A,[])]
		return //
		Op((Prolog e) -> PRED_qsort_3_static_exec(e), VA(PRED_qsort_0_s92, V(m), Prolog.Nil), cont);
	}
	...
	*/
	...
	private final static Operation qsort_3_1(Prolog m) {
		...
		a9 = CONS(a4, a8);
		return //
		Op((Prolog e) -> PRED_partition_4_static_exec(e), VA(a5, a4, a6, a7), //
				Op((Prolog e) -> PRED_qsort_3_static_exec(e), VA(a7, a8, a3), //
						Op((Prolog e) -> PRED_qsort_3_static_exec(e), VA(a6, a2, a9), cont)));
	}
