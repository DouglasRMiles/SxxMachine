...
public class FILE_query  extends TermData {
	/** PREDICATE: top/0
	...
	*/
	...
	public static Operation PRED_top_0_static_exec(Prolog m) {
		...
		// top:-[query]
		return //
		Op((Prolog e) -> PRED_query_0_static_exec(e), VA(), cont);
	}
	...
	*/
	...
	private final static Operation query_0_1(Prolog m) {
		...
		// query:-[query(A),fail]
		return //
		Op((Prolog e) -> PRED_query_1_static_exec(e), VA(V(m)), //
				Op(fail_0, VA(), cont));
	}
	...
	from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/query.pl
	*/
	private static final SymbolTerm PRED_query_1_s1 = SYM("[]");
	...
	public static Operation PRED_query_1_static_exec(Prolog m) {
		...
		if (a7.isCons()) {
			...
			a8 = argz[0];
			if (!PRED_query_1_s1.unify(argz[1], m.trail))
				return m.fail();
		} else if (a7.isVar()) {
			a8 = V(m);
			a7.bind(CONS(a8, PRED_query_1_s1), m.trail);
		} else {
			return m.fail();
		}
		a9 = V(m);
		Term[] y1 = VA(int_20, a4);
		a10 = S("*", y1);
		a11 = V(m);
		Term[] y2 = VA(int_21, a8);
		a12 = S("*", y2);
		return //
		Op((Prolog e) -> PRED_density_2_static_exec(e), VA(a2, a4), //
				Op((Prolog e) -> PRED_density_2_static_exec(e), VA(a6, a8), //
						Op((Prolog e) -> PRED_$greater_than_2_static_exec(e), VA(a4, a8), //
								Op(FILE_builtins::PRED_is_2_static_exec, VA(a9, a10), //
										Op(FILE_builtins::PRED_is_2_static_exec, VA(a11, a12), //
												Op((Prolog e) -> PRED_$less_than_2_static_exec(e), VA(a9, a11), cont))))));
	}
	...
	*/
	...
	public static Operation PRED_density_2_static_exec(Prolog m) {
		...
		a3 = V(m);
		a4 = V(m);
		Term[] y1 = VA(a3, int_100);
		a5 = S("*", y1);
		Term[] y2 = VA(a5, a4);
		a6 = S("//", y2);
		return //
		Op((Prolog e) -> PRED_pop_2_static_exec(e), VA(a1, a3), //
				Op((Prolog e) -> PRED_area_2_static_exec(e), VA(a1, a4), //
	...
	from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/query.pl
	*/
	private static final SymbolTerm PRED_pop_2_s1 = SYM("china");
	...
	private final static Operation pop_2_1(Prolog m) {
		...
		cont = m.cont;
		// pop(china,8250):-[]
		if (!PRED_pop_2_s1.unify(a1, m.trail))
			return m.fail();
	...
	from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/query.pl
	*/
	private static final SymbolTerm PRED_area_2_s1 = SYM("china");
	...
	private final static Operation area_2_1(Prolog m) {
		...
		cont = m.cont;
		// area(china,3380):-[]
		if (!PRED_area_2_s1.unify(a1, m.trail))
			return m.fail();
