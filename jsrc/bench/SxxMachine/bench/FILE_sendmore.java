...
public class FILE_sendmore  extends TermData {
	...
	*/
	...
	private final static Operation top_0_1(Prolog m) {
		...
		a11 = V(m);
		return //
		Op((Prolog e) -> PRED_digit_1_static_exec(e), VA(a1), //
				Op((Prolog e) -> PRED_digit_1_static_exec(e), VA(a2), //
						Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a1, a2), //
								Op((Prolog e) -> PRED_sumdigit_5_static_exec(e), VA(PRED_top_0_s1, a1, a2, a3, a4), //
										Op((Prolog e) -> PRED_digit_1_static_exec(e), VA(a5), //
												Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a5, a3), //
														Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a5, a2), //
																Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a5, a1), //
																		Op((Prolog e) -> PRED_digit_1_static_exec(e), VA(a6), //
																				Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a6, a5), //
																						Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a6, a3), //
																								Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a6, a2), //
																										Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a6, a1), //
																												Op((Prolog e) -> PRED_sumdigit_5_static_exec(e), VA(a4, a5, a6, a2, a7), //
																														Op((Prolog e) -> PRED_digit_1_static_exec(e), VA(a8), //
																																Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a8, a6), //
																																		Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a8, a5), //
																																				Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a8, a3), //
																																						Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e), VA(a8, a2), //
																																								Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(e),
																																										VA(a8, a1), //
																																										Op((Prolog e) -> PRED_sumdigit_5_static_exec(e),
																																												VA(a7, a2, a8, a5, a9), //
																																												Op((Prolog e) -> PRED_leftdigit_1_static_exec(e),
																																														VA(a10), //
																																														Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																e), VA(a10, a8), //
																																																Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																		e), VA(a10, a6), //
																																																		Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																				...
																																																				Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																						...
																																																						Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																								...
																																																								Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																										e),
																																																										VA(a10, a1), //
																																																										Op((Prolog e) -> PRED_leftdigit_1_static_exec(
																																																												e),
																																																												VA(a11), //
																																																												Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																														e),
																																																																				...
																																																																				Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																																						...
																																																																						Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																																								...
																																																																								Op((Prolog e) -> PRED_$arith_not_equal_2_static_exec(
																																																																										e),
																																																																										VA(a11, a1), //
																																																																										Op((Prolog e) -> PRED_sumdigit_5_static_exec(
																																																																												e),
																																																																												VA(a9, a10,
																																																																														a11,
																																																																														a8,
	...
	*/
	...
	public static Operation PRED_sumdigit_5_static_exec(Prolog m) {
		...
		//END inline expansion
		return //
		Op((Prolog e) -> PRED_$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fsendmore$002Epl_3_static_exec(e), VA(a4, a5, a6), cont);
	}
	...
	*/
	...
	static public void loadPreds() {
		...
		PredTable.registerBuiltin("$dummy_0_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/sendmore.pl",
				"$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fsendmore$002Epl", 3,
				FILE_sendmore::PRED_$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fsendmore$002Epl_3_static_exec);
