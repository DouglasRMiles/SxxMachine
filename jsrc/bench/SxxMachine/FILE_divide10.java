...
*/
    ...
    // top:-[divide10]
        return //
 Op(FILE_divide10::PRED_divide10_0_static_exec, VA(), cont);
    }
...
*/
    ...
    // divide10:-[d(x/x/x/x/x/x/x/x/x/x,x,A)]
        return //
 Op(FILE_divide10::PRED_d_3_static_exec, VA(L_divide10_0_s20,  ATOM_x , m.DONTCARE("execute(d(s(20),@(ATOM_x),void,cont))")), cont);
    }
/** PREDICATE: d/3
from: /mnt/gggg/opt/CYC_JRTL_with_CommonLisp/SxxMachine/prolog/bench/divide10.pl
*/
...
m.cont = cont;
    ...
    // d(A+B,C,D+E):-['$neck_cut',d(A,C,D),d(B,C,E)]
        ...
        p1 = //
 Op(FILE_divide10::PRED_d_3_static_exec, VA(a5, a2, a7), cont);
        m.AREGS[0] = a4;
        m.AREGS[1] = a2;
        m.AREGS[2] = a6;
        m.cont = p1;
 ...
 Op(FILE_divide10::PRED_d_3_static_exec, VA(a5, a2, a7), cont);
    ...
    // d(A*B,C,D*B+A*E):-['$neck_cut',d(A,C,D),d(B,C,E)]
        ...
        //END inline expansion
        p1 = //
 Op(FILE_divide10::PRED_d_3_static_exec, VA(a5, a2, a9), cont);
        m.AREGS[0] = a4;
        m.AREGS[1] = a2;
        m.AREGS[2] = a8;
        m.cont = p1;
    ...
    // d(A/B,C,(D*B-A*E)/B^2):-['$neck_cut',d(A,C,D),d(B,C,E)]
        ...
        //END inline expansion
        p1 = //
 Op(FILE_divide10::PRED_d_3_static_exec, VA(a5, a2, a11), cont);
        m.AREGS[0] = a4;
        m.AREGS[1] = a2;
        m.AREGS[2] = a10;
        m.cont = p1;
