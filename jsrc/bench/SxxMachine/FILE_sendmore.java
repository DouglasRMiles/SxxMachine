...
public class FILE_sendmore extends bootpreds {
/** PREDICATE: top/0
...
m.cont = cont;
 ...
 Op((e)->PRED_sumdigit_5_static_exec(e), VA( int_0 , a1, a2, a3, a4), //
 ...
 Op((e)->PRED_sumdigit_5_static_exec(e), VA(a9, a10, a11, a8, a11), fail_0)))))))))))))))))))))))))))))))))))));
    }
