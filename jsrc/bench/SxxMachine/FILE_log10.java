...
public class FILE_log10 extends FILE_system {
/** PREDICATE: top/0
from: /mnt/gggg/opt/CYC_JRTL_with_CommonLisp/SxxMachine/prolog/bench/log10.pl
*/
    // main(top/0,public)
    ...
    // top:-[log10]
        return //
 Op(FILE_log10::PRED_log10_0_static_exec, VA(), cont);
    }
/** PREDICATE: log10/0
from: /mnt/gggg/opt/CYC_JRTL_with_CommonLisp/SxxMachine/prolog/bench/log10.pl
*/
    ...
    // log10:-[d(log(log(log(log(log(log(log(log(log(log(x)))))))))),x,A)]
        return //
 Op(FILE_log10::PRED_d_3_static_exec, VA(L_log10_0_s22,  ATOM_x , m.DONTCARE("execute(d(s(22),@(ATOM_x),void,cont))")), cont);
    }
/** PREDICATE: d/3
from: /mnt/gggg/opt/CYC_JRTL_with_CommonLisp/SxxMachine/prolog/bench/log10.pl
*/
...
m.cont = cont;
    ...
    // d(A+B,C,D+E):-['$neck_cut',d(A,C,D),d(B,C,E)]
        ...
        p1 = //
 Op(FILE_log10::PRED_d_3_static_exec, VA(a5, a2, a7), cont);
        m.AREGS[0] = a4;
        m.AREGS[1] = a2;
        m.AREGS[2] = a6;
        m.cont = p1;
 ...
 Op(FILE_log10::PRED_d_3_static_exec, VA(a5, a2, a7), cont);
    ...
    // d(A*B,C,D*B+A*E):-['$neck_cut',d(A,C,D),d(B,C,E)]
        ...
        //END inline expansion
        p1 = //
 Op(FILE_log10::PRED_d_3_static_exec, VA(a5, a2, a9), cont);
        m.AREGS[0] = a4;
        m.AREGS[1] = a2;
        m.AREGS[2] = a8;
        m.cont = p1;
    ...
    // d(A/B,C,(D*B-A*E)/B^2):-['$neck_cut',d(A,C,D),d(B,C,E)]
        ...
        //END inline expansion
        p1 = //
 Op(FILE_log10::PRED_d_3_static_exec, VA(a5, a2, a11), cont);
        m.AREGS[0] = a4;
        m.AREGS[1] = a2;
        m.AREGS[2] = a10;
        m.cont = p1;
