...
public class FILE_perfect extends bootpreds {
/** PREDICATE: top/0
...
*/
    ...
    // top:-[findall(A,user:perfect(100,A),B),ok(B)]
        a1 = V(m);
        a2 = Closure( //
 Op((e)->PRED_perfect_2_static_exec(e), VA( int_100 , a1), null));
        a3 = V(m);
        return //
 Op((e)->PRED_findall_3_static_exec(e), VA(a1, a2, a3), //
 Op((e)->PRED_ok_1_static_exec(e), VA(a3), cont));
    }
/** PREDICATE: ok/1
from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/perfect.pl
*/
...
*/
    ...
    public static Operation PRED_$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fperfect$002Epl_2_static_exec(Prolog m) { 
        Operation cont = m.cont; Term[] LARG = m.AREGS; Operation thiz = m.pred;  
m.cont = cont;
        m.setB0();
        m.jtry2(null, FILE_perfect::$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fperfect$002Epl_2_sub_1);
        return $dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fperfect$002Epl_2_1(m);
    }

    private final static Operation $dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fperfect$002Epl_2_sub_1(Prolog m) { 
        m.trust(null);
        return $dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fperfect$002Epl_2_2(m);
    }

    private final static Operation $dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fperfect$002Epl_2_1(Prolog m) { 
    ...
    // '$dummy_0_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/perfect.pl'(A,B):-['$get_level'(C),divisible(A,B),'$cut'(C),fail]
        ...
        //END inline expansion
        return //
 Op((e)->PRED_divisible_2_static_exec(e), VA(a1, a2), //
 Op((e)->PRED_$cut_1_static_exec(e), VA(a3), fail_0));
    }

    private final static Operation $dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fperfect$002Epl_2_2(Prolog m) { 
...
m.cont = cont;
    ...
    // isprime([A|B],A):-[C is 2,D is 1,'$greater_than'(A,D),'$dummy_0_/opt/logicmoo_workspace/taupl/SxxMachine/prolog/bench/perfect.pl'(A,C)]
        ...
        //END inline expansion
        return //
 Op((e)->PRED_$dummy_0_$002Fopt$002Flogicmoo_workspace$002Ftaupl$002FSxxMachine$002Fprolog$002Fbench$002Fperfect$002Epl_2_static_exec(e), VA(a3, a4), cont);
    }
...
*/
 ...
 ;
        return //
 Op((e)->PRED_power_3_static_exec(e), VA( int_2 , a2, a4), //
 Op(FILE_builtins::PRED_is_2_static_exec, VA(a5, a6), //
 Op((e)->PRED_power_3_static_exec(e), VA( int_2 , a7, a8), //
...
m.cont = cont;
    ...
    // listperf([A|B],C):-[calc(2,A,C)]
        ...
        return //
 Op((e)->PRED_calc_3_static_exec(e), VA( int_2 , a3, a2), cont);
    }
...
*/
    ...
    // perfect(A,B):-[generateList(A,C),findall(D,user:isprime(C,D),E),listperf(E,B)]
        ...
        a4 = V(m);
        a5 = Closure( //
 Op((e)->PRED_isprime_2_static_exec(e), VA(a3, a4), null));
        a6 = V(m);
        return //
 Op((e)->PRED_generateList_2_static_exec(e), VA(a1, a3), //
 Op((e)->PRED_findall_3_static_exec(e), VA(a4, a5, a6), //
 Op((e)->PRED_listperf_2_static_exec(e), VA(a6, a2), cont)));
    }
static { loadPreds(); }
