...
m.cont = cont;
    ...
    // '$stream_property_specifier'(alias(A)):-[]
        a1 = a1.dref();
            if (!a1.unify(C( FUNCTOR_alias_1 , V(m)), m.trail)){
                return m.fail();
            }
        return cont;
    }
    ...
    // '$stream_property_specifier'((mode A)):-[]
        a1 = a1.dref();
            if (!a1.unify(C( FUNCTOR_mode_1 , V(m)), m.trail)){
                return m.fail();
            }
        return cont;
    }
    ...
    // '$stream_property_specifier'(type(A)):-[]
        a1 = a1.dref();
            if (!a1.unify(C( FUNCTOR_type_1 , V(m)), m.trail)){
                return m.fail();
            }
        return cont;
    }
    ...
    // '$stream_property_specifier'(file_name(A)):-[]
        a1 = a1.dref();
            if (!a1.unify(C( FUNCTOR_file_name_1 , V(m)), m.trail)){
                return m.fail();
            }
        return cont;
    }
