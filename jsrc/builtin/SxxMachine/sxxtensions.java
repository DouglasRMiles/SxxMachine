...
public class sxxtensions extends FILE_builtins {
  ...
  public Operation PRED_cputime_1_static_exec(Prolog m) {
    ...
    if (!m.AREGS[0].unify(Long(t), m.trail)) return m.fail();
    return m.cont;
  }
  ...
  public static boolean DoSetArg3(Prolog m, Term arg1, Term arg2, Term arg3) {
    ...
    arg2 = arg2.dref();
    arg3 = arg3.dref();
    if (!(arg1.isInteger())) return false;
    if (!(arg2.isStructure())) return false;
    int i = arg1.intValue();
    if (i < 1) return false;
    int l = arg2.arity();
    if (i > l) return false;
  ...
  public static boolean DoSetArg3_p2(Prolog m, int i, StructureTerm arg1,
      Term arg3) {
    if (m == null) {
  ...
  public static Operation PRED_setarg_3_static_exec(Prolog m) {
    m.setB0();
    if (!DoSetArg3(m, m.AREGS[0], m.AREGS[1], m.AREGS[2])) return m.fail();
    return m.cont;
  }
  ...
  static {
    PredTable.registerBuiltin("setarg", 3,
        sxxtensions::PRED_setarg_3_static_exec);
    PredTable.registerBuiltin("nb_setarg", 3,
        sxxtensions::PRED_nb_setarg_3_static_exec);
  }

  // A = foo(1), findall(A, (nb_setarg(1,A,2) ; true), L), [foo(2),foo(2)] = L.

  @SuppressWarnings("unused")
  static boolean NonBacktrackingSetArg(Prolog m, Term arg1, Term arg2,
      Term arg3) {
    arg1 = arg1.dref();
    arg2 = arg2.dref();
    arg3 = arg3.dref();

    if (!(arg1 instanceof IntegerTerm)) return false;
    if (arg2.isAtomicValue()) return false;
    int i = arg1.intValue();
    if (i < 1) return false;
    int l = arg2.arity();
    if (i > l) return false;
  ...
  public final static class SetArgTrail extends StructureTerm
      implements Undoable {
    Term OldValue;
    VariableTerm Which;
    Prolog m;
  ...
  public final static class PopPendingGoals extends StructureTerm
      implements Undoable {
    Prolog m;
    Term old;
  ...
  public final static class PopAssumptions extends StructureTerm
      implements Undoable {
    Prolog m;
    Term old;
  ...
  static {
    PredTable.registerBuiltin("freeze", 2,
        sxxtensions::PRED_freeze_2_static_exec);
    PredTable.registerBuiltin("frozen", 2,
        sxxtensions::PRED_frozen_2_static_exec);
  }
  ...
  static {
    PredTable.registerBuiltin("copy_term_nat", 2,
        sxxtensions::PRED_copy_term_nat_2_static_exec);
    PredTable.registerBuiltin("copy_term_att", 2,
        sxxtensions::PRED_copy_term_att_2_static_exec);
    PredTable.registerBuiltin("copy_term", 3,
        sxxtensions::PRED_copy_term_3_static_exec);

    PredTable.registerBuiltin("attvar", 1,
        sxxtensions::PRED_attvar_1_static_exec);
    PredTable.registerBuiltin("get_attr", 3,
        sxxtensions::PRED_get_attr_3_static_exec);
    PredTable.registerBuiltin("put_attr", 3,
        sxxtensions::PRED_put_attr_3_static_exec);
    PredTable.registerBuiltin("get_attrs", 2,
        sxxtensions::PRED_get_attrs_2_static_exec);
    PredTable.registerBuiltin("put_attrs", 2,
        sxxtensions::PRED_put_attrs_2_static_exec);
  }
  ...
  public static Operation PRED_get_attr_3_static_exec(Prolog m) {
    ...
    if (!t.isStructure()) return m.fail();
    if (!a3.unify(t.arg0(1), m.trail)) return m.fail();
    return m.cont;
  }
  ...
  public static Operation PRED_allassumed_1_static_exec(Prolog m) {
    Term arg1 = m.AREGS[0].dref();
    Term ass = (m.assumptions).dref();
    if (!(arg1.unify(ass, m.trail))) return m.fail();
    return m.cont;
  }
  ...
  public static void loadFile() {
    ...
    PredTable.registerBuiltin("add_pending", 1,
        sxxtensions::PRED_add_pending_1_static_exec);
    PredTable.registerBuiltin("push_pending", 1,
        sxxtensions::PRED_push_pending_1_static_exec);
    PredTable.registerBuiltin("peek_pending", 1,
        sxxtensions::PRED_peek_pending_1_static_exec);
    PredTable.registerBuiltin("assume", 1,
        sxxtensions::PRED_assume_1_static_exec);
    PredTable.registerBuiltin("allassumed", 1,
        sxxtensions::PRED_allassumed_1_static_exec);
  }

  public static Term get_attribute_goals(Term copy, Term frozen) {
    if (sxxtensions.isNoGoal(frozen)) return null;
