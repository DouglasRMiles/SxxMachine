...
public class FILE_system_preds  extends TermData {
	/** PREDICATE: system_predicate/1
	from: /opt/logicmoo_workspace/taupl/SxxMachine/prolog/builtin/system.pl
	*/
	final static SymbolTerm ATOM_otherwise = SYM("otherwise");
	...
	final static SymbolTerm ATOM_$0024neck_cut = SYM("$neck_cut");
	final static SymbolTerm ATOM_flush_output = SYM("flush_output");
	final static SymbolTerm ATOM_nl = SYM("nl");
	final static SymbolTerm ATOM_repeat = SYM("repeat");
	final static SymbolTerm ATOM_halt = SYM("halt");
	final static SymbolTerm ATOM_abort = SYM("abort");
	final static SymbolTerm ATOM_cafeteria = SYM("cafeteria");
	...
	static public void loadPreds() {
		PredTable.registerBuiltin("system_predicate", 1, FILE_system_preds::PRED_system_predicate_1_static_exec);
	}
}
