...
/** PREDICATE: top/0
from: /mnt/gggg/opt/CYC_JRTL_with_CommonLisp/SxxMachine/jsrc-pass20/bench/query.pl
*/
    // main(top/0,public)
...
*/
    // main(pop/2,public)
        ...
        final static Atomic ATOM_india = SYM("india");
        final static NumberTerm int_5863 = Integer(5863);
        final static Atomic ATOM_ussr = SYM("ussr");
        final static NumberTerm int_2521 = Integer(2521);
        final static Atomic ATOM_usa = SYM("usa");
        final static NumberTerm int_2119 = Integer(2119);
        final static Atomic ATOM_indonesia = SYM("indonesia");
        final static NumberTerm int_1276 = Integer(1276);
        final static Atomic ATOM_japan = SYM("japan");
        final static NumberTerm int_1097 = Integer(1097);
        final static Atomic ATOM_brazil = SYM("brazil");
        final static NumberTerm int_1042 = Integer(1042);
        final static Atomic ATOM_bangladesh = SYM("bangladesh");
        final static NumberTerm int_750 = Integer(750);
        final static Atomic ATOM_pakistan = SYM("pakistan");
        final static NumberTerm int_682 = Integer(682);
        final static Atomic ATOM_w_germany = SYM("w_germany");
        final static NumberTerm int_620 = Integer(620);
        final static Atomic ATOM_nigeria = SYM("nigeria");
        final static NumberTerm int_613 = Integer(613);
        final static Atomic ATOM_mexico = SYM("mexico");
        final static NumberTerm int_581 = Integer(581);
        final static Atomic ATOM_uk = SYM("uk");
        final static NumberTerm int_559 = Integer(559);
        final static Atomic ATOM_italy = SYM("italy");
        final static NumberTerm int_554 = Integer(554);
        final static Atomic ATOM_france = SYM("france");
        final static NumberTerm int_525 = Integer(525);
        final static Atomic ATOM_philippines = SYM("philippines");
        final static NumberTerm int_415 = Integer(415);
        final static Atomic ATOM_thailand = SYM("thailand");
        final static NumberTerm int_410 = Integer(410);
        final static Atomic ATOM_turkey = SYM("turkey");
        final static NumberTerm int_383 = Integer(383);
        final static Atomic ATOM_egypt = SYM("egypt");
        final static NumberTerm int_364 = Integer(364);
        final static Atomic ATOM_spain = SYM("spain");
        final static NumberTerm int_352 = Integer(352);
        final static Atomic ATOM_poland = SYM("poland");
        final static NumberTerm int_337 = Integer(337);
        final static Atomic ATOM_s_korea = SYM("s_korea");
        final static NumberTerm int_335 = Integer(335);
        final static Atomic ATOM_iran = SYM("iran");
        final static NumberTerm int_320 = Integer(320);
        final static Atomic ATOM_ethiopia = SYM("ethiopia");
        final static NumberTerm int_272 = Integer(272);
        final static Atomic ATOM_argentina = SYM("argentina");
