...
/** PREDICATE: top/0
from: /mnt/gggg/opt/CYC_JRTL_with_CommonLisp/SxxMachine/jsrc-pass20/bench/log10.pl
*/
    // main(top/0,public)
    ...
    // top:-[log10]
        return //
 Op("log10", FILE_log10::PRED_log10_0_static_exec, VA(), cont);
    }
/** PREDICATE: log10/0
from: /mnt/gggg/opt/CYC_JRTL_with_CommonLisp/SxxMachine/jsrc-pass20/bench/log10.pl
*/
    ...
    // log10:-[d(log(log(log(log(log(log(log(log(log(log(x)))))))))),x,A)]
        return //
 Op("d", FILE_log10::PRED_d_3_static_exec, VA(L_log10_0_s22,  ATOM_x , m.DONT_CARE2()), cont);
    }
/** PREDICATE: d/3
from: /mnt/gggg/opt/CYC_JRTL_with_CommonLisp/SxxMachine/jsrc-pass20/bench/log10.pl
*/
...
TermArray MARG = m.AREGS;   a1 = MARG.getAreg0();
    ...
    // d(A+B,C,D+E):-['$neck_cut',d(A,C,D),d(B,C,E)]
        ...
        p1 = //
 Op("d", FILE_log10::PRED_d_3_static_exec, VA(a5, a2, a7), cont);
...
TermArray MARG = m.AREGS;   a1 = MARG.getAreg0();
    ...
    // d(A*B,C,D*B+A*E):-['$neck_cut',d(A,C,D),d(B,C,E)]
        ...
        //END inline expansion
        p1 = //
 Op("d", FILE_log10::PRED_d_3_static_exec, VA(a5, a2, a9), cont);
m.AREGS = MARG;  MARG.setAreg0( a4);
MARG.setAreg1( a2);
MARG.setAreg2( a8);
        m.cont = p1;
...
TermArray MARG = m.AREGS;   a1 = MARG.getAreg0();
    ...
    // d(A/B,C,(D*B-A*E)/B^2):-['$neck_cut',d(A,C,D),d(B,C,E)]
        ...
        //END inline expansion
        p1 = //
 Op("d", FILE_log10::PRED_d_3_static_exec, VA(a5, a2, a11), cont);
m.AREGS = MARG;  MARG.setAreg0( a4);
MARG.setAreg1( a2);
MARG.setAreg2( a10);
        m.cont = p1;
