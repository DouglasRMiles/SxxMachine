...
TermArray MARG = m.AREGS;   a1 = MARG.getAreg0();
    ...
    // animal(A):-[write('please type one more animal name: '),flush_output,read(A)]
        return //
 Op("write", FILE_animal2::PRED_write_1_static_exec, VA( ATOM_please$0020type$0020one$0020more$0020animal$0020name$003A$0020 ), //
 Op("flush_output", FILE_animal2::PRED_flush_output_0_static_exec, VA(), //
 Op("read", FILE_animal2::PRED_read_1_static_exec, VA(a1), cont)));
    }
static { loadPreds(); }
static public void loadPreds() {
   PredTable.registerBuiltin("animal",1,FILE_animal2::PRED_animal_1_static_exec);
}
}
