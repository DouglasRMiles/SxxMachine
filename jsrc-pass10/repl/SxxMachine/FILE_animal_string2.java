...
TermArray MARG = m.AREGS;   a1 = MARG.getAreg0();
    ...
    // animal_string(A):-[write([112,108,101,97,115,101,32,116,121,112,101,32,111,110,101,32,109,111,114,101,32,97,110,105,109,97,108,32,110,97,109,101,58,32]),read(A)]
        return //
 Op("write", FILE_animal_string2::PRED_write_1_static_exec, VA(L_animal_string_1_s59), //
 Op("read", FILE_animal_string2::PRED_read_1_static_exec, VA(a1), cont));
    }
...
TermArray MARG = m.AREGS;   a1 = MARG.getAreg0();
    ...
    // animal_chars(A):-[write([112,108,101,97,115,101,32,116,121,112,101,32,111,110,101,32,109,111,114,101,32,97,110,105,109,97,108,32,110,97,109,101,58,32]),read(A)]
        return //
 Op("write", FILE_animal_string2::PRED_write_1_static_exec, VA(L_animal_chars_1_s59), //
 Op("read", FILE_animal_string2::PRED_read_1_static_exec, VA(a1), cont));
    }
static { loadPreds(); }
static public void loadPreds() {
   PredTable.registerBuiltin("animal_string",1,FILE_animal_string2::PRED_animal_string_1_static_exec);
   PredTable.registerBuiltin("animal_chars",1,FILE_animal_string2::PRED_animal_chars_1_static_exec);
}
}
