...
SxxMachine::SymbolTerm *const FILE_console_input::PRED_$003A_2_s1 = SYM("prolog");

	Operation FILE_console_input::PRED_$003A_2_static_exec(Prolog *m)
	{
		...
		{
		PRED_reverse_2_static_exec(e);
	}, VA({a6, a7}), Op([&] (Prolog *e)
	{
		PRED_complete_3_static_exec(e);
	}, VA({a7, a4, a5}), cont)));
	}

SxxMachine::SymbolTerm *const FILE_console_input::ATOM_$002A = SYM("*");

	Operation FILE_console_input::PRED_complete_3_static_exec(Prolog *m)
	{
		Operation cont = m->cont;
		m->cont = cont;
		m->setB0();
		m->jtry3(nullptr, FILE_console_input::complete_3_sub_1);
		return complete_3_1(m);
	}

	Operation FILE_console_input::complete_3_sub_1(Prolog *m)
	{
		m->trust(nullptr);
		return complete_3_2(m);
	}

	Operation FILE_console_input::complete_3_1(Prolog *m)
	{
		...
		return Op([&] (Prolog *e)
		{
		PRED_phrase_3_static_exec(e);
		}, VA({a5, a1, V(m)}), Op([&] (Prolog *e)
		{
		PRED_$cut_1_static_exec(e);
	}, VA({a4}), Op([&] (Prolog *e)
	{
		PRED_atom_concat_3_static_exec(e);
	}, VA({a2, ATOM_$002A, a6}), Op([&] (Prolog *e)
	{
		PRED_expand_file_name_2_static_exec(e);
	}, VA({a6, a3}), cont))));
	}

	Operation FILE_console_input::complete_3_2(Prolog *m)
	{
	...
	{
		PRED_$atom_completions_2_static_exec(e);
	}, VA({a2, a3}), cont)));
	}

	Operation FILE_console_input::PRED_atom_prefix_3_static_exec(Prolog *m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		...
		return Op([&] (Prolog *e)
		{
		PRED_atom_chars_3_static_exec(e);
...
SxxMachine::SymbolTerm *const FILE_console_input::PRED_atom_chars_3_s1 = SYM("[]");

	Operation FILE_console_input::PRED_atom_chars_3_static_exec(Prolog *m)
	{
		Operation cont = m->cont;
		m->cont = cont;
		m->setB0();
	...
	Operation FILE_console_input::atom_chars_3_var(Prolog *m)
	{
		m->jtry3(nullptr, FILE_console_input::atom_chars_3_var_1);
		return atom_chars_3_1(m);
	}

	Operation FILE_console_input::atom_chars_3_var_1(Prolog *m)
	{
		m->trust(nullptr);
		return atom_chars_3_2(m);
	}

	Operation FILE_console_input::atom_chars_3_1(Prolog *m)
	{
		...
		return Op([&] (Prolog *e)
		{
		PRED_atom_char_3_static_exec(e);
		}, VA({a4, a2, a7}), Op([&] (Prolog *e)
		{
		PRED_$cut_1_static_exec(e);
	}, VA({a6}), Op([&] (Prolog *e)
	{
	...
	Operation FILE_console_input::atom_chars_3_2(Prolog *m)
	{
		// atom_chars([],A,A):-true
		Term *a1, *a2, *a3;
		Operation cont;
	...
	Operation FILE_console_input::PRED_atom_char_3_static_exec(Prolog *m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		...
		return Op([&] (Prolog *e)
		{
		PRED_atom_char_1_static_exec(e);
		}, VA({a1}), Op([&] (Prolog *e)
		{
		PRED_$unify_2_static_exec(e);
	}, VA({a3, a4}), cont));
...
SxxMachine::SymbolTerm *const FILE_console_input::PRED_atom_char_1_s1 = SYM("csym");

	Operation FILE_console_input::PRED_atom_char_1_static_exec(Prolog *m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		...
		return Op([&] (Prolog *e)
		{
		PRED_code_type_2_static_exec(e);
		}, VA({a1, PRED_atom_char_1_s1}), cont);
	}

SxxMachine::IntegerTerm *const FILE_console_input::PRED_file_prefix_3_s1 = optional<int>(39);

	Operation FILE_console_input::PRED_file_prefix_3_static_exec(Prolog *m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		...
		return Op([&] (Prolog *e)
		{
		PRED_file_chars_3_static_exec(e);
		}, VA({a4, a2, a5}), Op([&] (Prolog *e)
		{
		PRED_$unify_2_static_exec(e);
	...
	}, VA({a1, a8}), Op([&] (Prolog *e)
	{
		PRED_$unify_2_static_exec(e);
	}, VA({a3, a6}), cont)))));
	}

SxxMachine::SymbolTerm *const FILE_console_input::PRED_file_chars_3_s1 = SYM("[]");

	Operation FILE_console_input::PRED_file_chars_3_static_exec(Prolog *m)
	{
		Operation cont = m->cont;
		m->cont = cont;
		m->setB0();
	...
	Operation FILE_console_input::file_chars_3_var(Prolog *m)
	{
		m->jtry3(nullptr, FILE_console_input::file_chars_3_var_1);
		return file_chars_3_1(m);
	}

	Operation FILE_console_input::file_chars_3_var_1(Prolog *m)
	{
		m->trust(nullptr);
		return file_chars_3_2(m);
	}

	Operation FILE_console_input::file_chars_3_1(Prolog *m)
	{
		...
		return Op([&] (Prolog *e)
		{
		PRED_file_char_3_static_exec(e);
		}, VA({a4, a2, a7}), Op([&] (Prolog *e)
		{
		PRED_$cut_1_static_exec(e);
	}, VA({a6}), Op([&] (Prolog *e)
	...
	Operation FILE_console_input::file_chars_3_2(Prolog *m)
	{
		// file_chars([],A,A):-true
		Term *a1, *a2, *a3;
		Operation cont;
	...
	Operation FILE_console_input::PRED_file_char_3_static_exec(Prolog *m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		...
		return Op([&] (Prolog *e)
		{
		PRED_file_char_1_static_exec(e);
		}, VA({a1}), Op([&] (Prolog *e)
		{
		PRED_$unify_2_static_exec(e);
	}, VA({a3, a4}), cont));
...
SxxMachine::SymbolTerm *const FILE_console_input::PRED_file_char_1_s1 = SYM("csym");
SxxMachine::IntegerTerm *const FILE_console_input::int_47 = optional<int>(47);
SxxMachine::IntegerTerm *const FILE_console_input::int_46 = optional<int>(46);
SxxMachine::IntegerTerm *const FILE_console_input::int_45 = optional<int>(45);
SxxMachine::IntegerTerm *const FILE_console_input::int_126 = optional<int>(126);

	Operation FILE_console_input::PRED_file_char_1_static_exec(Prolog *m)
	{
		Operation cont = m->cont;
		m->cont = cont;
		m->setB0();
		return m->switch_on_term(FILE_console_input::file_char_1_var, FILE_console_input::file_char_1_var, FILE_console_input::file_char_1_1, FILE_console_input::file_char_1_1, FILE_console_input::file_char_1_1, FILE_console_input::file_char_1_1);
	}

	Operation FILE_console_input::file_char_1_var(Prolog *m)
	{
		m->jtry1(nullptr, FILE_console_input::file_char_1_var_1);
		return file_char_1_1(m);
	}

	Operation FILE_console_input::file_char_1_var_1(Prolog *m)
	{
		m->retry(nullptr, FILE_console_input::file_char_1_var_2);
		return file_char_1_2(m);
	}

	Operation FILE_console_input::file_char_1_var_2(Prolog *m)
	{
		m->retry(nullptr, FILE_console_input::file_char_1_var_3);
		return file_char_1_3(m);
	}

	Operation FILE_console_input::file_char_1_var_3(Prolog *m)
	{
		m->retry(nullptr, FILE_console_input::file_char_1_var_4);
		return file_char_1_4(m);
	}

	Operation FILE_console_input::file_char_1_var_4(Prolog *m)
	{
		m->trust(nullptr);
		return file_char_1_5(m);
	}

	Operation FILE_console_input::file_char_1_1(Prolog *m)
	{
		...
		{
		PRED_code_type_2_static_exec(e);
		}, VA({a1, PRED_file_char_1_s1}), cont);
	}

	Operation FILE_console_input::file_char_1_2(Prolog *m)
	{
		// file_char(47):-true
		Term *a1;
		Operation cont;
	...
	Operation FILE_console_input::file_char_1_3(Prolog *m)
	{
		// file_char(46):-true
		Term *a1;
		Operation cont;
	...
	Operation FILE_console_input::file_char_1_4(Prolog *m)
	{
		// file_char(45):-true
		Term *a1;
		Operation cont;
	...
	Operation FILE_console_input::file_char_1_5(Prolog *m)
	{
		// file_char(126):-true
		Term *a1;
		Operation cont;
	...
	FILE_console_input::StaticConstructor::StaticConstructor()
	{
	loadPreds();
	}

FILE_console_input::StaticConstructor FILE_console_input::staticConstructor;

	void FILE_console_input::loadPreds()
	{
