...
//	import static SxxMachine.TermData.*;
	...
	Operation FILE_ops8::PRED_top_0_static_exec(Prolog* m)
	{
...
SymbolTerm* const  FILE_ops8::FUNCTOR_$002A_2 = F("*",2);
SymbolTerm* const  FILE_ops8::FUNCTOR_$002B_2 = F("+",2);
SymbolTerm* const  FILE_ops8::ATOM_x = SYM("x");
StructureTerm* const  FILE_ops8::L_ops8_0_s6 = S(FUNCTOR_$002B_2, ATOM_x, int_1);
SymbolTerm* const  FILE_ops8::FUNCTOR_$005E_2 = F("^",2);
StructureTerm* const  FILE_ops8::L_ops8_0_s10 = S(FUNCTOR_$005E_2, ATOM_x, int_2);
StructureTerm* const  FILE_ops8::L_ops8_0_s12 = S(FUNCTOR_$002B_2, L_ops8_0_s10, int_2);
StructureTerm* const  FILE_ops8::L_ops8_0_s15 = S(FUNCTOR_$005E_2, ATOM_x, int_3);
StructureTerm* const  FILE_ops8::L_ops8_0_s17 = S(FUNCTOR_$002B_2, L_ops8_0_s15, int_3);
StructureTerm* const  FILE_ops8::L_ops8_0_s19 = S(FUNCTOR_$002A_2, L_ops8_0_s12, L_ops8_0_s17);
StructureTerm* const  FILE_ops8::L_ops8_0_s21 = S(FUNCTOR_$002A_2, L_ops8_0_s6, L_ops8_0_s19);

	Operation FILE_ops8::PRED_ops8_0_static_exec(Prolog* m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		Operation thiz = m->pred;
...
SymbolTerm* const  FILE_ops8::FUNCTOR_$002D_2 = F("-",2);
SymbolTerm* const  FILE_ops8::FUNCTOR_$002F_2 = F("/",2);
SymbolTerm* const  FILE_ops8::FUNCTOR_$002D_1 = F("-",1);
SymbolTerm* const  FILE_ops8::FUNCTOR_exp_1 = F("exp",1);
SymbolTerm* const  FILE_ops8::FUNCTOR_log_1 = F("log",1);

	Operation FILE_ops8::PRED_d_3_static_exec(Prolog* m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		Operation thiz = m->pred;
	...
	Operation FILE_ops8::d_3_top(Prolog* m)
	{
		m->setB0();
	...
	Operation FILE_ops8::d_3_var(Prolog* m)
	{
		m->jtry3(nullptr, FILE_ops8::d_3_var_1);
		return d_3_1(m);
	}

	Operation FILE_ops8::d_3_var_1(Prolog* m)
	{
		m->retry(nullptr, FILE_ops8::d_3_var_2);
		return d_3_2(m);
	}

	Operation FILE_ops8::d_3_var_2(Prolog* m)
	{
		m->retry(nullptr, FILE_ops8::d_3_var_3);
		return d_3_3(m);
	}

	Operation FILE_ops8::d_3_var_3(Prolog* m)
	{
		m->retry(nullptr, FILE_ops8::d_3_var_4);
		return d_3_4(m);
	}

	Operation FILE_ops8::d_3_var_4(Prolog* m)
	{
		m->retry(nullptr, FILE_ops8::d_3_var_5);
		return d_3_5(m);
	}

	Operation FILE_ops8::d_3_var_5(Prolog* m)
	{
		m->retry(nullptr, FILE_ops8::d_3_var_6);
		return d_3_6(m);
	}

	Operation FILE_ops8::d_3_var_6(Prolog* m)
	{
		m->retry(nullptr, FILE_ops8::d_3_var_7);
		return d_3_7(m);
	}

	Operation FILE_ops8::d_3_var_7(Prolog* m)
	{
		m->retry(nullptr, FILE_ops8::d_3_var_8);
		return d_3_8(m);
	}

	Operation FILE_ops8::d_3_var_8(Prolog* m)
	{
		m->retry(nullptr, FILE_ops8::d_3_var_9);
		return d_3_9(m);
	}

	Operation FILE_ops8::d_3_var_9(Prolog* m)
	{
		m->trust(nullptr);
		return d_3_10(m);
	}

	Operation FILE_ops8::d_3_int(Prolog* m)
	{
		m->jtry3(nullptr, FILE_ops8::d_3_int_1);
		return d_3_9(m);
	}

	Operation FILE_ops8::d_3_int_1(Prolog* m)
	{
		m->trust(nullptr);
		return d_3_10(m);
	}

	Operation FILE_ops8::d_3_1(Prolog* m)
	{
	...
	Operation FILE_ops8::d_3_2(Prolog* m)
	{
	// d(A-B,C,D-E):-!,d(A,C,D),d(B,C,E)
		 Term* a1,* a2,* a3,* a4,* a5,* a6,* a7;
		Operation p1;
	...
	Operation FILE_ops8::d_3_3(Prolog* m)
	{
	...
	Operation FILE_ops8::d_3_4(Prolog* m)
	{
	...
	Operation FILE_ops8::d_3_5(Prolog* m)
	{
	...
	Operation FILE_ops8::d_3_6(Prolog* m)
	{
	// d(-A,B,-C):-!,d(A,B,C)
		 Term* a1,* a2,* a3,* a4,* a5;
		Operation cont;
	...
	Operation FILE_ops8::d_3_7(Prolog* m)
	{
	...
	Operation FILE_ops8::d_3_8(Prolog* m)
	{
	...
	Operation FILE_ops8::d_3_9(Prolog* m)
	{
	// d(A,A,1):-!
		 Term* a1,* a2,* a3;
		Operation cont;
	...
	Operation FILE_ops8::d_3_10(Prolog* m)
	{
	// d(A,B,0):-true
		 Term* a1,* a2,* a3;
		Operation cont;
	...
	FILE_ops8::StaticConstructor::StaticConstructor()
	{
	FILE_builtins::loadPreds();
	}

FILE_ops8::StaticConstructor FILE_ops8::staticConstructor;

	void FILE_ops8::loadPreds()
	{
