...
//	import static SxxMachine.TermData.*;
	...
	// top:-[serialise]
		return Op([&] (e)
		{
		PRED_serialise_0_static_exec(e);
		}, VA(), cont);
	}
...
SymbolTerm* const  FILE_serialise::FUNCTOR_$002B_2 = F("+",2);
	...
	FILE_serialise::StaticConstructor::StaticConstructor()
	{
	FILE_builtins::loadPreds();
	}

FILE_serialise::StaticConstructor FILE_serialise::staticConstructor;

	void FILE_serialise::loadPreds()
	{
