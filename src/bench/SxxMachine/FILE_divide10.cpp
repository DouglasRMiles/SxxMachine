...
SymbolTerm* const  FILE_divide10::FUNCTOR_log_1 = F("log",1);
	...
	FILE_divide10::StaticConstructor::StaticConstructor()
	{
	FILE_builtins::loadPreds();
	}

FILE_divide10::StaticConstructor FILE_divide10::staticConstructor;

	void FILE_divide10::loadPreds()
	{
