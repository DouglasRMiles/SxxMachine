...
//	import static SxxMachine.TermData.*;
	...
	Operation FILE_queens_8::PRED_top_0_static_exec(Prolog* m)
	{
		...
		m->cont = cont;
		m->setB0();
		m->jtry0(nullptr, FILE_queens_8::top_0_sub_1);
		return top_0_1(m);
	}

	Operation FILE_queens_8::top_0_sub_1(Prolog* m)
	{
		m->trust(nullptr);
		return top_0_2(m);
	}

	Operation FILE_queens_8::top_0_1(Prolog* m)
	{
	// top:-queens(8,A),fail
		Operation p1;
		Operation cont;
	...
	// top:-[queens(8,A),fail]
		return Op([&] (e)
		{
		PRED_queens_2_static_exec(e);
		}, VA({ int_8, V(m) }), Failure::fail_0);
	}

	Operation FILE_queens_8::top_0_2(Prolog* m)
	{
	// top:-true
		Operation cont;
		cont = m->cont;
	...
	Operation FILE_queens_8::PRED_queens_2_static_exec(Prolog* m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		Operation thiz = m->pred;
	...
	// queens(A,B):-[range(1,A,C),queens(C,[],B)]
		...
		return Op([&] (e)
		{
		PRED_range_3_static_exec(e);
		}, VA({ int_1, a1, a3 }), Op([&] (e)
		{
		PRED_queens_3_static_exec(e);
	}, VA({ a3, Prolog::Nil, a2 }), cont));
	}

	Operation FILE_queens_8::PRED_queens_3_static_exec(Prolog* m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		Operation thiz = m->pred;
	...
	Operation FILE_queens_8::queens_3_var(Prolog* m)
	{
		m->jtry3(nullptr, FILE_queens_8::queens_3_var_1);
		return queens_3_1(m);
	}

	Operation FILE_queens_8::queens_3_var_1(Prolog* m)
	{
		m->trust(nullptr);
		return queens_3_2(m);
	}

	Operation FILE_queens_8::queens_3_1(Prolog* m)
	{
	// queens([],A,A):-true
		 Term* a1,* a2,* a3;
		Operation cont;
	...
	Operation FILE_queens_8::queens_3_2(Prolog* m)
	{
	...
	// queens(A,B,C):-[select(A,D,E),not_attack(B,E),queens(D,[E|B],C)]
		...
		{
		PRED_not_attack_2_static_exec(e);
	}, VA({ a2, a5 }), Op([&] (e)
	{
		PRED_queens_3_static_exec(e);
	}, VA({ a4, a6, a3 }), cont)));
	...
	Operation FILE_queens_8::PRED_not_attack_2_static_exec(Prolog* m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		Operation thiz = m->pred;
	...
	// not_attack(A,B):-[not_attack(A,B,1)]
		return Op([&] (e)
		{
		PRED_not_attack_3_static_exec(e);
		}, VA({ a1, a2, int_1 }), cont);
	}

SymbolTerm* const  FILE_queens_8::FUNCTOR_$002B_2 = F("+",2);
SymbolTerm* const  FILE_queens_8::FUNCTOR_$002D_2 = F("-",2);

	Operation FILE_queens_8::PRED_not_attack_3_static_exec(Prolog* m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		Operation thiz = m->pred;
	...
	Operation FILE_queens_8::not_attack_3_top(Prolog* m)
	{
		m->setB0();
		return m->switch_on_term(FILE_queens_8::not_attack_3_var, Failure::fail_0, Failure::fail_0, FILE_queens_8::not_attack_3_1, Failure::fail_0, FILE_queens_8::not_attack_3_2);
	}

	Operation FILE_queens_8::not_attack_3_var(Prolog* m)
	{
		m->jtry3(nullptr, FILE_queens_8::not_attack_3_var_1);
		return not_attack_3_1(m);
	}

	Operation FILE_queens_8::not_attack_3_var_1(Prolog* m)
	{
		m->trust(nullptr);
		return not_attack_3_2(m);
	}

	Operation FILE_queens_8::not_attack_3_1(Prolog* m)
	{
	// not_attack([],A,B):-!
		 Term* a1,* a2,* a3;
		Operation cont;
	...
	Operation FILE_queens_8::not_attack_3_2(Prolog* m)
	{
	...
	Operation FILE_queens_8::PRED_select_3_static_exec(Prolog* m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		Operation thiz = m->pred;
	...
	Operation FILE_queens_8::select_3_top(Prolog* m)
	{
		m->setB0();
		return m->switch_on_term(FILE_queens_8::select_3_var, Failure::fail_0, Failure::fail_0, Failure::fail_0, Failure::fail_0, FILE_queens_8::select_3_var);
	}

	Operation FILE_queens_8::select_3_var(Prolog* m)
	{
		m->jtry3(nullptr, FILE_queens_8::select_3_var_1);
		return select_3_1(m);
	}

	Operation FILE_queens_8::select_3_var_1(Prolog* m)
	{
		m->trust(nullptr);
		return select_3_2(m);
	}

	Operation FILE_queens_8::select_3_1(Prolog* m)
	{
	// select([A|B],B,A):-true
		 Term* a1,* a2,* a3,* a4,* a5;
		Operation cont;
	...
	Operation FILE_queens_8::select_3_2(Prolog* m)
	{
	...
	Operation FILE_queens_8::PRED_range_3_static_exec(Prolog* m)
	{
		Operation cont = m->cont;
		std::vector<Term*> LARG = m->AREGS;
		Operation thiz = m->pred;
	...
	Operation FILE_queens_8::range_3_top(Prolog* m)
	{
		m->setB0();
		m->jtry3(nullptr, FILE_queens_8::range_3_sub_1);
		return range_3_1(m);
	}

	Operation FILE_queens_8::range_3_sub_1(Prolog* m)
	{
		m->trust(nullptr);
		return range_3_2(m);
	}

	Operation FILE_queens_8::range_3_1(Prolog* m)
	{
	// range(A,A,[A]):-!
		 Term* a1,* a2,* a3;
		Operation cont;
	...
	Operation FILE_queens_8::range_3_2(Prolog* m)
	{
	...
	FILE_queens_8::StaticConstructor::StaticConstructor()
	{
	FILE_builtins::loadPreds();
	}

FILE_queens_8::StaticConstructor FILE_queens_8::staticConstructor;

	void FILE_queens_8::loadPreds()
	{
