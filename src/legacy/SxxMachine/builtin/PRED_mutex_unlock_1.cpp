...
namespace SxxMachine
{
	...
	PRED_mutex_unlock_1::PRED_mutex_unlock_1(Term *a0, Operation cont)
	{
		this->LARG[0] = a0; //0];
		this->cont = cont;
	}

	Operation PRED_mutex_unlock_1::exec(Prolog *engine) throw(PrologException)
	{
		Term *a1 = LARG[0]->dref();
