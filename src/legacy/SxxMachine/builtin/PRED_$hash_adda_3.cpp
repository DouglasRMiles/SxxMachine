...
SxxMachine::SymbolTerm *const PRED_$hash_adda_3::SYM_NIL = SxxMachine::Prolog::Nil;

	PRED_$hash_adda_3::PRED_$hash_adda_3(Term *a1, Term *a2, Term *a3, Operation cont)
	{
		LARG[0] = a1;
		LARG[1] = a2;
		LARG[2] = a3;
	...
	Operation PRED_$hash_adda_3::exec(Prolog *engine)
	{
		engine->setB0();
		Term *a1, *a2, *a3;
		a1 = LARG[0];
