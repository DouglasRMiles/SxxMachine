...
SxxMachine::IntegerTerm *const PRED_peek_code_2::INT_EOF = new SxxMachine::IntegerTerm(-1);

	PRED_peek_code_2::PRED_peek_code_2(Term *a1, Term *a2, Operation cont)
	{
		LARG[0] = a1;
		LARG[1] = a2;
		this->cont = cont;
	...
	Operation PRED_peek_code_2::exec(Prolog *engine)
	{
		engine->setB0();
		Term *a1, *a2;
		a1 = LARG[0];
