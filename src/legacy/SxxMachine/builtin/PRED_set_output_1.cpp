...
namespace SxxMachine
{
	...
	PRED_set_output_1::PRED_set_output_1(Term *a1, Operation cont)
	{
		LARG[0] = a1;
		this->cont = cont;
	}

	Operation PRED_set_output_1::exec(Prolog *engine)
	{
		engine->setB0();
		Term *a1;
		a1 = LARG[0];
	...
	engine->setCurrentOutput(any_cast<PrintWriter*>(stream));
		return cont;
	}
}
