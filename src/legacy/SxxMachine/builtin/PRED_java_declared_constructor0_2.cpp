...
#include "PRED_java_declared_constructor0_2.h"
...
namespace SxxMachine
{
	...
	PRED_java_declared_constructor0_2::PRED_java_declared_constructor0_2(Term *a1, Term *a2, Operation cont)
	{
	LARG[0] = a1;
	LARG[1] = a2;
	this->cont = cont;
	...
	Operation PRED_java_declared_constructor0_2::exec(Prolog *engine)
	{
	...
	Term *PRED_java_declared_constructor0_2::toPrologTerm(any obj)
	{
