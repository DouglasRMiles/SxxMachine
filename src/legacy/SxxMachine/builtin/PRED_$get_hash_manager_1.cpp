...
#include "PRED_$get_hash_manager_1.h"
...
namespace SxxMachine
{
	...
	PRED_$get_hash_manager_1::PRED_$get_hash_manager_1(Term *a1, Operation cont)
	{
		LARG[0] = a1;
		this->cont = cont;
	}

	Operation PRED_$get_hash_manager_1::exec(Prolog *engine)
	{
		engine->setB0();
		Term *a1;
		a1 = LARG[0];
	...
	FFIObjectTerm tempVar(engine->getHashManager());
