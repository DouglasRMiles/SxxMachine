...
namespace SxxMachine
{
	...
	PRED_$fast_write_2::PRED_$fast_write_2(Term *a1, Term *a2, Operation cont)
	{
	LARG[0] = a1;
	LARG[1] = a2;
	this->cont = cont;
	...
	Operation PRED_$fast_write_2::exec(Prolog *engine)
	{
		engine->setB0();
	Term *a1, *a2;
		a1 = LARG[0];
...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
	(any_cast<PrintWriter*>(stream)).print(a2->dref()->toString());
	return cont;
	}
}
