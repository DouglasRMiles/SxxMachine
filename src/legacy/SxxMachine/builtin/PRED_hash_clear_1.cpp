...
namespace SxxMachine
{
	...
	PRED_hash_clear_1::PRED_hash_clear_1(Term *a1, Operation cont)
	{
		LARG[0] = a1;
		this->cont = cont;
	}

	Operation PRED_hash_clear_1::exec(Prolog *engine)
	{
		engine->setB0();
		Term *a1;
		a1 = LARG[0];
