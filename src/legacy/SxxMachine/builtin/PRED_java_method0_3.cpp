...
namespace SxxMachine
{
	...
	PRED_java_method0_3::PRED_java_method0_3(Term *a1, Term *a2, Term *a3, Operation cont)
	{
	LARG[0] = a1;
	LARG[1] = a2;
	LARG[2] = a3;
	...
	Operation PRED_java_method0_3::exec(Prolog *engine)
	{
	...
	try
	{
		...
		{ // No argument method
		m = clazz.getMethod(a2->asSymbolTerm()->name());
	...
	Term *PRED_java_method0_3::toPrologTerm(any obj)
	{
