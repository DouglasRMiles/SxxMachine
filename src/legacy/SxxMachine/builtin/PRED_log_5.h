...
//	import static SxxMachine.PRED_loggable_1.LEVELS;
	 ...
	 *
	 */
	class PRED_log_5 : public Predicate
	{
		// private final Term LARG[0], LARG[1], LARG[2], LARG[3], arg5;

	public:
		PRED_log_5(Term *a0, Term *a1, Term *a2, std::vector<Term*> &LARG, Term *arg5, Operation cont);
