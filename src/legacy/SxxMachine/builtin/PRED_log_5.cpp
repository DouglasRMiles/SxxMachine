...
//	import static SxxMachine.PRED_loggable_1.LEVELS;
	...
	PRED_log_5::PRED_log_5(Term *a0, Term *a1, Term *a2, std::vector<Term*> &LARG, Term *arg5, Operation cont)
	{
		this->LARG[0] = a0; //0];
		this->LARG[1] = a1; //1];
		this->LARG[2] = a2; //2];
	...
	Operation PRED_log_5::exec(Prolog *engine) throw(PrologException)
	{
