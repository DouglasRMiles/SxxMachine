...
SxxMachine::SymbolTerm *const PRED_get_char_2::SYM_EOF = SxxMachine::SymbolTerm::intern("end_of_file");

	PRED_get_char_2::PRED_get_char_2(Term *a1, Term *a2, Operation cont)
	{
		LARG[0] = a1;
		LARG[1] = a2;
		this->cont = cont;
