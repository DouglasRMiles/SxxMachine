...
namespace SxxMachine
{
	...
	PRED_flush_output_1::PRED_flush_output_1(Term *a1, Operation cont)
	{
		LARG[0] = a1;
		this->cont = cont;
	}

	Operation PRED_flush_output_1::exec(Prolog *engine)
	{
		engine->setB0();
		Term *a1;
		a1 = LARG[0];
	...
	(any_cast<PrintWriter*>(stream)).flush();
		return cont;
	}
}
