...
namespace SxxMachine
{
	...
	PRED_put_byte_2::PRED_put_byte_2(Term *a1, Term *a2, Operation cont)
	{
		LARG[0] = a1;
		LARG[1] = a2;
		this->cont = cont;
	...
	Operation PRED_put_byte_2::exec(Prolog *engine)
	{
		engine->setB0();
		Term *a1, *a2;
		a1 = LARG[0];
	...
	{
		throw IllegalTypeException(this, 2, "byte", a2);
	}
	...
	// print single byte
	(any_cast<PrintWriter*>(stream)).print(static_cast<char>(c));
	return cont;
	}
}
