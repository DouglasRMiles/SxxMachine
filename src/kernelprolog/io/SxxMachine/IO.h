...
namespace SxxMachine { class IOPeer; }
namespace SxxMachine { class system; }
class StringBuilder;
...
namespace SxxMachine
{
	...
	*/
	...
	public:
		...
		static void trace(const int& level, const std::string& s);
		...
		static Reader* url2stream(const std::string& f, const bool& quiet);
