#ifndef PRED_EXISTS_DIRECTORY_1
#define PRED_EXISTS_DIRECTORY_1
...
namespace SxxMachine::am2j
{
	...
	class PRED_exists_directory_1 : public Predicate::P1
	{
  public:
	  PRED_exists_directory_1(Term* a1, Operation next);
...
#endif	//#ifndef PRED_EXISTS_DIRECTORY_1
