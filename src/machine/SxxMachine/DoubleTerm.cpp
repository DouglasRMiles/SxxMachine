...
namespace SxxMachine
{
	...
	DoubleTerm::DoubleTerm(const double& i)
	{
		this->value = i;
	}
...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
	...
	void DoubleTerm::toStringImpl(const int& printFlags, StringBuilder* sb)
	{
		sb->append(this->value);
	}

	bool DoubleTerm::equalsTerm(Term* obj, Comparator* comparator)
	{
