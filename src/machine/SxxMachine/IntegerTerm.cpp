...
namespace SxxMachine
{
	...
	bool IntegerTerm::unifyInt(const int& i, Trail* trail)
	{
	   return intValue() == i;
	}

	IntegerTerm::IntegerTerm(const int& i) : LongTerm(i)
	{
	}
...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
	...
	void IntegerTerm::toStringImpl(const int& printFlags, StringBuilder* sb)
	{
		sb->append(this->intValue());
	}

	bool IntegerTerm::equalsTerm(Term* obj, Comparator* comparator)
	{
