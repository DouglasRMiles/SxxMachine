...
unordered_map<wstring, Operation> PredTable::initsCache = unordered_map<wstring, Operation>();
	...
	void PredTable::registerPredicate(const wstring &pkg, const wstring &functor, int arity, Operation cont)
	{
		registerPredicate(pkg, functor, arity, cont, false);
	}

	void PredTable::registerPredicate(const wstring &pkg, const wstring &functor, int arity, Operation cont, bool forced)
	{
	...
	bool PredTable::storePred(const wstring &key, Operation cont, bool forced)
	{
	...
	void PredTable::registerWMangle(const wstring &pkg, const wstring &functor, const wstring &mangle, int arity, Operation cont)
	{
		registerPredicate(pkg, functor, arity, cont);
		registerPredicate(pkg, mangle, arity, cont);
	}

	wstring PredTable::keyString(const wstring &pkg, const wstring &functor, int arity)
	{
		if (pkg == "" || isGlobal(pkg))
		{
	...
	wstring PredTable::PredFA(const wstring &functor, int arity)
	{
	...
	Operation PredTable::findPredicateOp(const wstring &pkg, const wstring &functor, int arity)
	{
	...
	void PredTable::registerBuiltin(const wstring &functor, int arity, Operation cont)
	{
	...
	void PredTable::registerFileEntryPoint(const wstring &module, const wstring &functor, int arity, Operation cont)
	{
	...
	void PredTable::registerBuiltin(const wstring &functor, const wstring &mangle, int arity, Operation cont)
	{
