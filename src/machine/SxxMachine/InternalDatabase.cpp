...
namespace SxxMachine
{
	...
	InternalDatabase::InternalDatabase(int n) : reusableIndices(list<int>())
	{
		this->maxContents = n;
	...
	InternalDatabase *InternalDatabase::copyInternalDatabase(bool deepCopy, IdentityHashMap<any, Term*> *copyHash)
	{
		   return new InternalDatabase(this, deepCopy, copyHash);
	}

	InternalDatabase::InternalDatabase(InternalDatabase *src, bool deepCopy, IdentityHashMap<any, Term*> *copyHash) : reusableIndices(list<int>(src->reusableIndices))
	{
	...
	Term *InternalDatabase::get(int i)
	{
		return this->buffer[i];
	}

	Term *InternalDatabase::erase(int i)
	{
