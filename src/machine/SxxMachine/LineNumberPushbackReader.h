...
namespace SxxMachine
{
	...
	public:
		LineNumberPushbackReader(Reader *in_Renamed);
		LineNumberPushbackReader(Reader *in_Renamed, int size);
		/**
	...
	public:
		 ...
		 *          If an I/O error occurs
		 */
		void mark(int readAheadLimit) throw(IOException) override;
		/**
		...
		void unread(int c) throw(IOException) override;
		void unread(std::vector<char> &cbuf, int off, int len) throw(IOException) override;
	};
