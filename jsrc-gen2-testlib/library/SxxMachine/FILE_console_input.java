...
public class FILE_console_input extends TermData {
	...
	public static Operation PRED_atom_chars_3_static_exec(Prolog m) {
		...
		m.cont = cont;
		m.setB0();
		return m.switch_on_term(FILE_console_input::atom_chars_3_var, fail_0, fail_0,
				FILE_console_input::atom_chars_3_2, fail_0, FILE_console_input::atom_chars_3_1);
	}
	...
	public static Operation PRED_file_chars_3_static_exec(Prolog m) {
		...
		m.cont = cont;
		m.setB0();
		return m.switch_on_term(FILE_console_input::file_chars_3_var, fail_0, fail_0,
				FILE_console_input::file_chars_3_2, fail_0, FILE_console_input::file_chars_3_1);
	}
	...
	public static Operation PRED_file_char_1_static_exec(Prolog m) {
		...
		m.cont = cont;
		m.setB0();
		return m.switch_on_term(FILE_console_input::file_char_1_var, FILE_console_input::file_char_1_var,
				FILE_console_input::file_char_1_1, FILE_console_input::file_char_1_1, FILE_console_input::file_char_1_1,
