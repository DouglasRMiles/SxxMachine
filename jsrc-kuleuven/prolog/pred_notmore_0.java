...
protected final pred_notmore_0_consts getConsts() { return consts; }
...
local_aregs[0] = var1 ;
local_aregs[1] = new StructureTerm(getConsts().string4,var1.dref(),getConsts().posint10,new StructureTerm(getConsts().string0, new HeapChoice(mach.getCUTB()),new StructureTerm(getConsts().string6,var1.dref(),new StructureTerm(getConsts().string7,continuation)))) ;
    mach.updateCUTB();
