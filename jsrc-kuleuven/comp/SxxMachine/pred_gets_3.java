...
class pred_gets_3_consts {
    ...
    final static String string4 = Const.strIntern("getforarg");
...
class pred_gets_3_1 extends pred_gets_3 {
    ...
    protected Term[] getArgs() {
        ...
        Term arg0 = JpFactory.S(getConsts().string2, var1, JpFactory.CONST(getConsts().string5));
        Term arg1 = var2;
        Term arg2 = var3;
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(JpFactory.S(getConsts().string2, var1.dref(), JpFactory.CONST(getConsts().string5)))))
            return mach.Fail0;
