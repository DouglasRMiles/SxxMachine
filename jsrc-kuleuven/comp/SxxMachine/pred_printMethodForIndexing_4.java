...
public class pred_printMethodForIndexing_4 extends Code {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs.setAreg0((S(pred_printMethodForIndexing_4_consts.string3, CONST(pred_printMethodForIndexing_4_consts.string4), S(pred_printMethodForIndexing_4_consts.string3, S(pred_printMethodForIndexing_4_consts.string5, CONST(pred_printMethodForIndexing_4_consts.string6)), S(pred_printMethodForIndexing_4_consts.string3, CONST(pred_printMethodForIndexing_4_consts.string7), S(pred_printMethodForIndexing_4_consts.string3, S(pred_printMethodForIndexing_4_consts.string5, CONST(pred_printMethodForIndexing_4_consts.string6)), S(pred_printMethodForIndexing_4_consts.string3, CONST(pred_printMethodForIndexing_4_consts.string8), S(pred_printMethodForIndexing_4_consts.string3, S(pred_printMethodForIndexing_4_consts.string5, CONST(pred_printMethodForIndexing_4_consts.string6)), S(pred_printMethodForIndexing_4_consts.string3, S(pred_printMethodForIndexing_4_consts.string9, var1
