...
public class pred_printMainConstruction_1 extends Code {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs.setAreg0((S(pred_printMainConstruction_1_consts.string3, CONST(pred_printMainConstruction_1_consts.string4), S(pred_printMainConstruction_1_consts.string3, var1
