...
class pred_binarize_clauses_3_consts {
    ...
    final static String string1 = Const.strIntern("binarize_clauses");
    final static String string2 = Const.strIntern(".");
    final static String string3 = Const.strIntern("binarize");
    final static String string4 = Const.strIntern("addclausetoprogram");
...
class pred_binarize_clauses_3_2 extends pred_binarize_clauses_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs[1] = var5;
        local_aregs[2] = JpFactory.S(getConsts().string4, var5.dref(), var3.dref(), var6, JpFactory
                .S(getConsts().string1, var2.dref(), var6.dref(), var4.dref(), continuation));
        mach.updateCUTB();
        local_aregs[3] = null;
