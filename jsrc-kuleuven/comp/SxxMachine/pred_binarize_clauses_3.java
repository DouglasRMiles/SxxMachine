...
class pred_binarize_clauses_3_1 extends pred_binarize_clauses_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(CONST(pred_binarize_clauses_3_consts.string5))))
            return mach.Fail0;
...
class pred_binarize_clauses_3_2 extends pred_binarize_clauses_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(S(pred_binarize_clauses_3_consts.string2, var1.dref(), var2.dref()))))
            return mach.Fail0;
        ...
        local_aregs[2] = S(pred_binarize_clauses_3_consts.string4, var5.dref(), var3
