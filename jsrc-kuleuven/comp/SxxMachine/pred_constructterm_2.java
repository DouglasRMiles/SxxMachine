...
class pred_constructterm_2_4 extends pred_constructterm_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs.setAreg0((S(pred_constructterm_2_consts.string5, var3
...
class pred_constructterm_2_6 extends pred_constructterm_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs.setAreg1((S(pred_constructterm_2_consts.string0, new HeapChoice(
...
class pred_constructterm_2_7 extends pred_constructterm_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs.setAreg3((S(pred_constructterm_2_consts.string3, var1
