...
class pred_fixBody_2_1 extends pred_fixBody_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(CONST(pred_fixBody_2_consts.string5))))
            return mach.Fail0;

        if (!(areg1.unify(CONST(pred_fixBody_2_consts.string5))))
            return mach.Fail0;
...
class pred_fixBody_2_2 extends pred_fixBody_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(S(pred_fixBody_2_consts.string3, var1.dref(), var2.dref()))))
            return mach.Fail0;

        if (!(areg1.unify(S(pred_fixBody_2_consts.string3, var3.dref(), var4.dref()))))
            return mach.Fail0;
