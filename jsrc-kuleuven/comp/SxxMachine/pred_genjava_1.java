...
class pred_genjava_1_1 extends pred_genjava_1 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(CONST(pred_genjava_1_consts.string4))))
            return mach.Fail0;
...
class pred_genjava_1_2 extends pred_genjava_1 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(S(pred_genjava_1_consts.string2, var1.dref(), var2.dref()))))
            return mach.Fail0;
        local_aregs[0] = var1.dref();

        local_aregs[1] = S(pred_genjava_1_consts.string1, var2.dref(), continuation);
        mach.updateCUTB();
