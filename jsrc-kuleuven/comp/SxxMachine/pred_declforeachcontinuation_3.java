...
class pred_declforeachcontinuation_3_consts {
    ...
    final static String string1 = Const.strIntern("declforeachcontinuation");
    ...
    final static String string5 = Const.strIntern("     Code ");
    final static String string6 = Const.strIntern("cont ;");
...
class pred_declforeachcontinuation_3_1 extends pred_declforeachcontinuation_3 {
    ...
    protected Term[] getArgs() {
        ...
        Term arg0 = JpFactory.CONST(getConsts().string9);
        Term arg1 = var1;
        Term arg2 = var2;
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(JpFactory.CONST(getConsts().string9))))
            return mach.Fail0;
...
class pred_declforeachcontinuation_3_3 extends pred_declforeachcontinuation_3 {
    ...
    protected Term[] getArgs() {
        ...
        Term arg0 = JpFactory.S(getConsts().string2, JpFactory
                .S(getConsts().string3, JpFactory.CONST(getConsts().string10), getConsts().posint1), var1);
        Term arg1 = var2;
        Term arg2 = var3;
        return new Term[] { arg0, arg1, arg2 };
    }
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(JpFactory.S(getConsts().string2, JpFactory
                .S(getConsts().string3, JpFactory.CONST(getConsts().string10), getConsts().posint1), var1.dref()))))
            return mach.Fail0;
...
class pred_declforeachcontinuation_3_4 extends pred_declforeachcontinuation_3 {
    ...
    protected Term[] getArgs() {
        ...
        Term var1 = new DummyVar();
        Term arg0 = JpFactory.S(getConsts().string2, JpFactory
                .S(getConsts().string3, JpFactory.CONST(getConsts().string10), getConsts().posint2), var1);
        Term arg1 = var2;
        Term arg2 = var3;
        return new Term[] { arg0, arg1, arg2 };
    }
    ...
    public Code exec(PrologMachine mach) {
        ...
        Term var1 = JpFactory.JVAR(mach);
        if (!(areg0.unify(JpFactory.S(getConsts().string2, JpFactory
                .S(getConsts().string3, JpFactory.CONST(getConsts().string10), getConsts().posint2), var1.dref()))))
            return mach.Fail0;
        if (!(areg1.unify(var2.dref())))
            return mach.Fail0;
        if (!(areg2.unify(var3.dref())))
...
class pred_declforeachcontinuation_3_5 extends pred_declforeachcontinuation_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg2.unify(var5.dref())))
            return mach.Fail0;
        local_aregs[0] = JpFactory.S(getConsts().string2, JpFactory.CONST(getConsts().string5), JpFactory
                .S(getConsts().string2, var1.dref(), JpFactory.S(getConsts().string2, var2.dref(), JpFactory
                        .S(getConsts().string2, JpFactory.CONST(getConsts().string6), JpFactory
                                .S(getConsts().string2, JpFactory.S(getConsts().string7, JpFactory
                                        .CONST(getConsts().string8)), JpFactory.CONST(getConsts().string9))))));
        local_aregs[1] = JpFactory.S(getConsts().string1, var3.dref(), var4.dref(), var5.dref(), continuation);
        mach.updateCUTB();
        local_aregs[3] = local_aregs[2] = null;
