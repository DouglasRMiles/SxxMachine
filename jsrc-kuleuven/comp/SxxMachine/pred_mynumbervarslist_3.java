...
class pred_mynumbervarslist_3_1 extends pred_mynumbervarslist_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(CONST(pred_mynumbervarslist_3_consts.string4))))
            return mach.Fail0;
...
class pred_mynumbervarslist_3_2 extends pred_mynumbervarslist_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(S(pred_mynumbervarslist_3_consts.string2, var1.dref(), var2.dref()))))
            return mach.Fail0;
        ...
        local_aregs[3] = S(pred_mynumbervarslist_3_consts.string1, var2.dref(), var5.dref(), var4.dref(), continuation);
        mach.updateCUTB();
