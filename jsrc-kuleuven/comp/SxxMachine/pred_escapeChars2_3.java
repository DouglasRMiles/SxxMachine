...
class pred_escapeChars2_3_1 extends pred_escapeChars2_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unifyJP(CONST(pred_escapeChars2_3_consts.string4))))
            return mach.Fail0;
...
class pred_escapeChars2_3_2 extends pred_escapeChars2_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unifyJP(S(pred_escapeChars2_3_consts.string2, var1.dref(), var2.dref()))))
            return mach.Fail0;
        ...
        local_aregs.setAreg1((S(pred_escapeChars2_3_consts.string2, var1.dref(), CONST(pred_escapeChars2_3_consts.string4))));
