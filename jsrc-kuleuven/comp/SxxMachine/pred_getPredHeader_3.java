...
class pred_getPredHeader_3_consts {
    ...
    final static String string1 = internS("getPredHeader");
...
class pred_getPredHeader_3_1 extends pred_getPredHeader_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs[2] = S(pred_getPredHeader_3_consts.string0, new HeapChoice(mach.getCUTB()), continuation);
        mach.updateCUTB();
        local_aregs[3] = null;
...
class pred_getPredHeader_3_2 extends pred_getPredHeader_3 {
    ...
    protected Term[] getArgs() {
        ...
        final Term arg2 = CONST(pred_getPredHeader_3_consts.string2);
        return new Term[] { arg0, arg1, arg2 };
    }
