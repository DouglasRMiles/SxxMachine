...
public class pred_prelude_0 extends Code {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs.areg0 = (S(pred_prelude_0_consts.string3, CONST(pred_prelude_0_consts.string4), S(pred_prelude_0_consts.string3, S(pred_prelude_0_consts.string5, CONST(pred_prelude_0_consts.string6)), S(pred_prelude_0_consts.string3, CONST(pred_prelude_0_consts.string7), S(pred_prelude_0_consts.string3, S(pred_prelude_0_consts.string5, CONST(pred_prelude_0_consts.string6)), S(pred_prelude_0_consts.string3, CONST(pred_prelude_0_consts.string8), S(pred_prelude_0_consts.string3, S(pred_prelude_0_consts.string5, CONST(pred_prelude_0_consts.string6)), S(pred_prelude_0_consts.string3, S(pred_prelude_0_consts.string5, CONST(pred_prelude_0_consts.string6)), CONST(pred_prelude_0_consts.string9)))))))));
