...
class pred_fixClauses_2_1 extends pred_fixClauses_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs[1] = S(pred_fixClauses_2_consts.string0, new HeapChoice(mach.getCUTB()), continuation);
        mach.updateCUTB();
        local_aregs[2] = null;
...
class pred_fixClauses_2_3 extends pred_fixClauses_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs[0] = S(pred_fixClauses_2_consts.string1, var1.dref(), var3
...
class pred_fixClauses_2_4 extends pred_fixClauses_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs[1] = S(pred_fixClauses_2_consts.string0, new HeapChoice(
