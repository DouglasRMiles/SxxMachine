...
class pred_isIndexingAllowed_1_1 extends pred_isIndexingAllowed_1 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs[1] = CONST(pred_isIndexingAllowed_1_consts.string8);

        local_aregs[2] = S(pred_isIndexingAllowed_1_consts.string0, new HeapChoice(
...
class pred_isIndexingAllowed_1_2 extends pred_isIndexingAllowed_1 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs[2] = S(pred_isIndexingAllowed_1_consts.string7, var2
