...
class pred_getPackageName_1_consts {
    ...
    final static String string1 = Const.strIntern("getPackageName");
    final static String string2 = Const.strIntern("SxxMachine");
    final static String string3 = Const.strIntern("call");
    final static String string4 = Const.strIntern("nb_current");
...
class pred_getPackageName_1_1 extends pred_getPackageName_1 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!(areg0.unify(var1.dref())))
            return mach.Fail0;
        local_aregs[0] = JpFactory.CONST(getConsts().string5);
...
class pred_getPackageName_1_2 extends pred_getPackageName_1 {
    ...
    @SuppressWarnings("static-access")
    protected Term[] getArgs() {
        Term arg0 = JpFactory.CONST(getConsts().string2);
        return new Term[] { arg0 };
    }
    ...
    public Code exec(PrologMachine mach) {
        ...
        Term continuation = local_aregs[1];
        Term areg0 = local_aregs[0].dref();
        if (!(areg0.unify(JpFactory.CONST(getConsts().string2))))
            return mach.Fail0;
