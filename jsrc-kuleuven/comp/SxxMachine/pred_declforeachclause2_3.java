...
class pred_declforeachclause2_3_consts {
    ...
    final static String string1 = Const.strIntern("declforeachclause2");
    final static String string2 = Const.strIntern(".");
    final static String string3 = Const.strIntern("writel");
    final static String string4 = Const.strIntern("ALT.addAlternative(");
    final static String string5 = Const.strIntern("new ");
    final static String string6 = Const.strIntern("_");
    final static String string7 = Const.strIntern("(this));");
    ...
    final static String string11 = Const.strIntern("inc");
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs[0] = JpFactory.S(getConsts().string2, JpFactory.CONST(getConsts().string4), JpFactory
                .S(getConsts().string2, JpFactory.CONST(getConsts().string5), JpFactory
                        .S(getConsts().string2, var4.dref(), JpFactory.S(getConsts().string2, JpFactory
                                .CONST(getConsts().string6), JpFactory.S(getConsts().string2, var3
        ...
        local_aregs[1] = JpFactory.S(getConsts().string11, var5, var3.dref(), JpFactory
