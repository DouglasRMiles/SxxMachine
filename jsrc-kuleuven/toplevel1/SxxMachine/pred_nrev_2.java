...
public class pred_nrev_2 extends Code {
    ...
    static String string5 = Const.strIntern("nrev");
...
class pred_nrev_2_2 extends pred_nrev_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs[1] = var4;
        local_aregs[2] = JpFactory.S(string3, var4.dref(), JpFactory
                .S(string1, var1.dref(), JpFactory.CONST(string2)), var3.dref(), continuation);
        mach.updateCUTB();
        return entry_code;
    }
}
