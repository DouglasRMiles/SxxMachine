...
class pred_maketerm_3_5 extends pred_maketerm_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs.setAreg1((S(string4, S(string10, var5), var6)));
        local_aregs.setAreg2((var1.dref()));
        local_aregs.setAreg3((S(string13, var7, var8, var5.dref(), S(string18, var7.dref(), var3
...
class pred_maketerm_3_7 extends pred_maketerm_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!((areg2).unifyJP(var4)))
            return mach.Fail0;
        local_aregs.setAreg0((var5));
        local_aregs.setAreg1((S(string4, S(string10, CONST(string3)), var6)));
        if (!endsWith(var1, "]"))
            return mach.Fail0;
        local_aregs.setAreg2((var1.dref()));
...
class pred_maketerm_3_8 extends pred_maketerm_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!((areg2).unifyJP(var4)))
            return mach.Fail0;
        local_aregs.setAreg0((var5));
        local_aregs.setAreg1((S(string4, S(string10, CONST(string22)), var6)));
        local_aregs.setAreg2((var1.dref()));
...
class pred_maketerm_3_9 extends pred_maketerm_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!((areg2).unifyJP(var3)))
            return mach.Fail0;
        local_aregs.setAreg0((var4));
        local_aregs.setAreg1((S(string4, S(string10, CONST(string2)), CONST(string6))));
        local_aregs.setAreg2((var1.dref()));
...
class pred_maketerm_3_10 extends pred_maketerm_3 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!((areg2).unifyJP(var3)))
            return mach.Fail0;
        local_aregs.setAreg0((var4));
        local_aregs.setAreg1((S(string4, S(string10, CONST(string7)), CONST(string6))));
        local_aregs.setAreg2((var1.dref()));
