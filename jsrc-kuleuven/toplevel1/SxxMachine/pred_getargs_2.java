...
class pred_getargs_2_1 extends pred_getargs_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        local_aregs.setAreg1((S(string3, S(string6, CONST(string1)), CONST(string4))));
        local_aregs.setAreg2((var1.dref()));
        local_aregs.setAreg3((S(string8, var3
...
class pred_getargs_2_2 extends pred_getargs_2 {
    ...
    public Code exec(PrologMachine mach) {
        ...
        if (!((areg1).unifyJP(var2)))
            return mach.Fail0;
        local_aregs.setAreg0((var3));
        local_aregs.setAreg1((S(string3, S(string6, CONST(string2)), var4)));
        local_aregs.setAreg2((var1.dref()));
